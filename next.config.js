...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspDirectives = [
      ...
      "connect-src 'self' https://api.stripe.com https://*.amazonaws.com https://*.inmovaapp.com https://www.google-analytics.com https://client.crisp.chat wss://client.relay.crisp.chat https://*.sentry.io https://cloudflareinsights.com",
