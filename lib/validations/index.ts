...
export const buildingCreateSchema = z.object({
  ...
  numeroUnidades: z.number()
    ...
    .optional(),
  tipo: z.enum(['residencial', 'comercial', 'mixto', 'otro'])
    .optional()
    .default('residencial'),
  anoConstructor: z.number()
...
export const tenantCreateSchema = z.object({
  ...
  nacionalidad: z.string()
    ...
    .optional(),
  estado: z.enum(['activo', 'inactivo', 'moroso', 'pendiente'])
    .optional()
    .default('activo'),
  ocupacion: z.string()
    .max(200, 'La ocupación no puede exceder 200 caracteres')
    .optional(),
...
const contractBaseSchema = z.object({
  ...
  deposito: z.number()
    ...
    .optional(),
  estado: z.enum(['activo', 'vencido', 'cancelado'])
    .optional()
    .default('activo'),
...
export const paymentCreateSchema = z.object({
  ...
  concepto: z.string()
    ...
    .trim(),
  estado: z.enum(['pendiente', 'pagado', 'atrasado'])
    .optional()
    .default('pendiente'),
  metodoPago: z.enum(['efectivo', 'transferencia', 'tarjeta', 'cheque', 'domiciliacion', 'otro'])
    .optional(),
  fechaPago: z.string()
...
export const maintenanceCreateSchema = z.object({
  ...
  descripcion: z.string()
    ...
    .trim(),
  tipo: z.enum(['correctivo', 'preventivo', 'emergencia', 'mejora'])
    .optional()
    .default('correctivo'),
  prioridad: z.enum(['baja', 'media', 'alta'])
    .optional()
    .default('media'),
  estado: z.enum(['pendiente', 'en_progreso', 'programado', 'completado'])
    .optional()
    .default('pendiente'),
