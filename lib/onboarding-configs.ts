...
export const ONBOARDING_ALQUILER_TRADICIONAL: OnboardingStep[] = [
  {
    ...
    description:
      'Vamos a configurar tu sistema de gestión de alquileres. Este proceso tomará solo 3 minutos y te ayudará a digitalizar completamente tu negocio.',
    icon: '🎉',
  },
  {
    id: 'import_option',
    ...
    description:
      'Si ya gestionas propiedades, podemos importar tus datos desde Excel o CSV. Si prefieres, también puedes empezar desde cero con datos de ejemplo.',
    icon: '📂',
  ...
  },
  {
    ...
    description:
      'Una propiedad puede ser un edificio completo, una casa o cualquier inmueble. Después podrás añadir unidades (apartamentos, locales, etc.) dentro de ella.',
  ...
  },
  {
    ...
    description:
      'Las unidades son los espacios alquilables (apartamentos, locales, oficinas). Cada unidad puede tener su propio contrato e inquilino.',
  ...
  },
  {
    ...
    description:
      'Usa nuestras plantillas predefinidas para generar contratos profesionales en segundos. Puedes personalizarlas según tus necesidades.',
  ...
  },
  {
    ...
    description:
      'Automatiza el seguimiento de pagos, envía recordatorios y genera recibos automáticamente. Puedes integrar Stripe, transferencias o efectivo.',
  ...
  },
  {
    ...
    description:
      'Desde el dashboard verás tus KPIs, ingresos, ocupación y alertas. Explora los 88 módulos disponibles para personalizar tu experiencia.',
...
export const ONBOARDING_ROOM_RENTAL: OnboardingStep[] = [
  {
    ...
    description:
      'Vamos a configurar tu sistema para gestionar pisos compartidos o coliving. Incluye prorrateo automático de gastos y gestión de convivencia.',
    icon: '🏚️',
  },
  {
    id: 'shared_home',
    ...
    description:
      'Define la vivienda que vas a compartir. Indica cuántas habitaciones tiene y qué zonas comunes se comparten (cocina, baño, salón).',
  ...
  },
  {
    ...
    description:
      'Crea una ficha para cada habitación con su precio mensual, características (baño privado, exterior, etc.) y fotos.',
  ...
  },
  {
    ...
    description:
      'Define cómo se reparten los gastos comunes (luz, agua, internet). Puedes hacerlo por igual, por porcentaje o personalizado.',
  ...
  },
  {
    ...
    description:
      'Establece las reglas de la vivienda (horarios, limpieza, visitas). Usa nuestra plantilla predefinida o crea la tuya propia.',
  ...
  },
  {
    ...
    description:
      'Tu sistema de coliving está configurado. Ahora puedes publicar las habitaciones disponibles y gestionar inquilinos de forma sencilla.',
...
export const ONBOARDING_STR: OnboardingStep[] = [
  {
    ...
    description:
      'Vamos a centralizar la gestión de tus alquileres vacacionales. Podrás sincronizar Airbnb, Booking y otras plataformas en un solo lugar.',
    icon: '🏝️',
  },
  {
    ...
    description:
      'Si ya tienes propiedades en Airbnb, Booking u otras plataformas, podemos importarlas automáticamente. Si no, te ayudaremos a crear tus primeros anuncios.',
  ...
  },
  {
    ...
    description:
      'Sincroniza tus cuentas de Airbnb, Booking, Expedia y VRBO. La sincronización es bidireccional y en tiempo real.',
  ...
  },
  {
    ...
    description:
      'Detectaremos automáticamente tus anuncios actuales y los importaremos con toda su información (fotos, descripción, precios, calendarios).',
  ...
  },
  {
    ...
    description:
      'Usa nuestro motor de pricing para ajustar automáticamente tus tarifas según demanda, temporada y competencia. Maximiza tus ingresos sin esfuerzo.',
  ...
  },
  {
    ...
    description:
      'Ahora puedes gestionar todas tus reservas, calendarios y precios desde un solo panel. Revisa tus métricas (RevPAR, ADR, ocupación) en tiempo real.',
...
export const ONBOARDING_FLIPPING: OnboardingStep[] = [
  {
    ...
    description:
      'Vamos a configurar tu primer proyecto de inversión inmobiliaria. Haré el seguimiento completo: compra, reforma, venta y ROI.',
    icon: '💹',
  },
  {
    id: 'project_creation',
    ...
    description:
      'Introduce los datos básicos de la propiedad: precio de compra, ubicación, metros cuadrados y estado actual. Te mostraremos el precio/m² del mercado.',
  ...
  },
  {
    ...
    description:
      'Calcula el coste de la reforma por categorías (estructura, instalaciones, acabados). Te mostraremos benchmarks de €/m² típicos.',
  ...
  },
  {
    ...
    description:
      'Estima el precio de venta objetivo y el plazo previsto. Calcularemos el ROI y TIR en tiempo real mientras introduces los datos.',
  ...
  },
  {
    ...
    description:
      '¿Cómo vas a financiar el proyecto? Define si usas capital propio, hipoteca, inversores o un modelo mixto. Ajustaremos la TIR.',
  ...
  },
  {
    ...
    description:
      'Tu proyecto de flipping está configurado. Ahora podrás hacer seguimiento de costes, plazos y ROI. Recibirás alertas si algo se desvía.',
...
export const ONBOARDING_CONSTRUCCION: OnboardingStep[] = [
  {
    ...
    description:
      'Vamos a configurar tu proyecto de obra nueva o rehabilitación integral. Gestiona permisos, fases, agentes y viabilidad financiera.',
    icon: '🏗️',
  },
  {
    id: 'project_type',
    ...
    description:
      'Define si es obra nueva residencial, terciaria, rehabilitación o promoción. Generaremos automáticamente el checklist de permisos necesarios.',
  ...
  },
  {
    ...
    description:
      'Te mostraremos todos los permisos y licencias necesarias con plazos estimados. Recibirás alertas antes de que caduquen.',
  ...
  },
  {
    ...
    description:
      'Registra a arquitecto, aparejador, constructor, gestoría y demás profesionales. Podrás asignarles tareas y hacer seguimiento.',
  ...
  },
  {
    ...
    description:
      'Planifica las fases del proyecto (cimentación, estructura, cerramientos, instalaciones, acabados). Incluye duración y presupuesto por fase.',
  ...
  },
  {
    ...
    description:
      'Ya puedes gestionar tu obra desde el dashboard. Visualiza el Gantt, controla costes y recibe alertas de hitos críticos.',
...
export const ONBOARDING_PROFESIONAL: OnboardingStep[] = [
  {
    ...
    description:
      'Configura tu sistema de facturación por horas para servicios de arquitectura, ingeniería o asesoría inmobiliaria.',
    icon: '💼',
  },
  {
    id: 'services',
    ...
    description:
      'Crea tu catálogo de servicios con tarifas por hora o proyecto. Ejemplos: "Diseño arquitectónico", "Dirección de obra", "Asesoría legal".',
  ...
  },
  {
    ...
    description:
      'Activa el timer integrado para registrar horas trabajadas en cada proyecto. También puedes usar la app móvil.',
  ...
  },
  {
    ...
    description:
      'Configura facturación automática mensual para clientes con retainer. Las facturas se generarán y enviarán solas.',
  ...
  },
  {
    ...
    description:
      'Genera una web pública con tus proyectos, testimonios y formulario de contacto. Ideal para captar nuevos clientes.',
  ...
  },
  {
    ...
    description:
      'Ahora puedes gestionar proyectos, facturar clientes y hacer seguimiento de tu rentabilidad. ¡Manos a la obra!',
...
export const ONBOARDING_COMUNIDADES: OnboardingStep[] = [
  {
    ...
    description:
      'Configura la administración de fincas: copropietarios, juntas, votaciones, derramas y espacios comunes.',
    icon: '🏛️',
  },
  {
    id: 'community_setup',
    ...
    description:
      'Registra la finca (dirección, número de propietarios, CIF de la comunidad) y los espacios comunes (piscina, gimnasio, salón social).',
  ...
  },
  {
    ...
    description:
      'Añade los copropietarios con sus coeficientes de propiedad. Estos coeficientes se usarán para calcular derramas y cuotas.',
  ...
  },
  {
    ...
    description:
      'Usa el asistente para convocar juntas (ordinarias o extraordinarias) con plantillas legales predefinidas. Envío automático certificado.',
  ...
  },
  {
    ...
    description:
      'Activa votación electrónica para que los propietarios voten desde su móvil. Cálculo automático de mayorías y generación de actas.',
  ...
  },
  {
    ...
    description:
      'Tu sistema de gestión de comunidades está listo. Gestiona juntas, derramas, espacios comunes y comunicaciones desde un solo lugar.',
...
function mapBusinessVerticalToModelo(vertical: string): ModeloNegocio {
  const mapping: Record<string, ModeloNegocio> = {
    ...
    flipping: 'flipping',
    servicios_profesionales: 'professional',
    mixto: 'general',
  };
