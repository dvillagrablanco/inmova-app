...
export const RoomRentalWizardLazy = dynamic(
  () =>
    import('@/components/wizards/RoomRentalWizard').then((mod) => ({
      default: mod.RoomRentalWizard,
    })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
...
export const PropertyWizardLazy = dynamic(
  () =>
    import('@/components/wizards/PropertyWizard').then((mod) => ({ default: mod.PropertyWizard })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  }
...
export const SetupWizardLazy = dynamic(() => import('@/components/wizards/SetupWizard'), {
  loading: () => <LoadingSpinner />,
  ssr: false,
});
...
export const IntelligentChatbotLazy = dynamic(
  () =>
    import('@/components/chatbot/IntelligentChatbot').then((mod) => ({
      default: mod.IntelligentChatbot,
    })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
...
export const MFASettingsLazy = dynamic(() => import('@/components/MFASettings'), {
  loading: () => <LoadingSpinner />,
  ssr: false,
});

export const MFASetupLazy = dynamic(
  () => import('@/components/security/mfa-setup').then((mod) => ({ default: mod.MFASetup })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  }
...
export const VerticalSpecificWidgetsLazy = dynamic(
  () =>
    import('@/components/dashboard/VerticalSpecificWidgets').then((mod) => ({
      default: mod.VerticalSpecificWidgets,
    })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
...
export const EnhancedGlobalSearchLazy = dynamic(
  () =>
    import('@/components/ui/enhanced-global-search').then((mod) => ({
...
export const MultiFileUploadLazy = dynamic(
  () =>
    import('@/components/ui/multi-file-upload').then((mod) => ({ default: mod.MultiFileUpload })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  }
...
export const AdvancedFiltersLazy = dynamic(
  () =>
    import('@/components/ui/advanced-filters').then((mod) => ({ default: mod.AdvancedFilters })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  }
...
export const ResponsiveDataTableLazy = dynamic(
  () =>
    import('@/components/ui/responsive-data-table').then((mod) => ({
      default: mod.ResponsiveDataTable,
    })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
...
export const AIAssistantLazy = dynamic(
  () => import('@/components/automation/AIAssistant').then((mod) => ({ default: mod.AIAssistant })),
  {
    loading: () => <LoadingSpinner />,
    ssr: false,
  }
