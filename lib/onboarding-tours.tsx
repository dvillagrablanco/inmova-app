...
export const VERTICAL_TOURS: Record<BusinessVertical, VerticalTour> = {
  alquiler_tradicional: {
    ...
    setupActions: [
      ...
      {
        id: 'cuadro_mandos',
        title: 'Explorar Cuadro de Mandos',
        description: 'PyG Analítica por centro de coste con KPIs de cartera',
        route: '/finanzas/cuadro-de-mandos',
      ...
      },
      {
        ...
        description: 'Visión consolidada: inmobiliario + financiero + PE',
      ...
      {
        id: 'sugerencias_inteligentes',
        title: 'Revisar Sugerencias de Gestión',
        description: 'El sistema analiza tus datos y sugiere mejoras',
        route: '/family-office/dashboard',
        icon: 'Lightbulb',
        completed: false,
        weight: 5,
      ...
      {
        id: 'estructura_grupo',
        title: 'Ver Estructura del Grupo',
        description: 'Organigrama societario con KPIs por empresa',
        route: '/inversiones/grupo',
        icon: 'Building2',
        completed: false,
        weight: 5,
      },
      {
        id: 'modelo_720',
        title: 'Revisar Modelo 720',
        description: 'Declaración de bienes en el extranjero',
        route: '/inversiones/modelo-720',
        icon: 'Globe',
        completed: false,
        weight: 5,
      },
      {
        id: 'conectar_bancos',
        title: 'Conectar Bancos (Open Banking)',
        description: 'Sincroniza saldos y movimientos automáticamente',
        route: '/family-office/cuentas',
        icon: 'Link2',
        completed: false,
        weight: 10,
      },
