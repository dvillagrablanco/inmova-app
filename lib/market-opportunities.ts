...
async function scrapeBOEAuctions(): Promise<MarketOpportunity[]> {
  ...
  try {
    ...
    $('.resultado-busqueda, .rowClass, table.datosSubasta tr, .listadoResult .box-info').each(
      (idx, el) => {
        ...
        const titulo =
          $el.find('.titulo-subasta, .dBien h4, h3 a, .info-col strong').first().text().trim() ||
        ...
        const importeMatch = text.match(
          /(?:Importe|Cantidad|Puja\s+m[ií]nima)[:\s]*([\d.,]+)\s*€?/i
        );
        const superficieMatch = text.match(/([\d.,]+)\s*m[²2]/);
        const provinciaMatch = text.match(
          /(?:Provincia|Localidad|Ubicaci[oó]n)[:\s]*([A-ZÁÉÍÓÚÑa-záéíóúñ\s]+)/
        );
        ...
        results.push({
          ...
          estimatedYield:
            price > 0 && market > 0 ? Math.round(((market * 0.05) / price) * 1000) / 10 : undefined,
          riskLevel: 'alto',
          ...
          url: link
            ? link.startsWith('http')
              ? link
              : `${BOE_BASE}/${link}`
            : `${BOE_BASE}/subastas_ava.php?accion=Buscar&dato%5B3%5D=I`,
  ...
  const templates = [
    {
      ...
      items: [
        {
          title: 'Piso 3 hab. zona norte Madrid',
          price: 180000,
          market: 320000,
          surface: 85,
          type: 'vivienda',
        ...
        {
          title: 'Local comercial centro Madrid',
          price: 95000,
          market: 200000,
          surface: 65,
          type: 'local',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Piso Eixample para reformar',
          price: 200000,
          market: 380000,
          surface: 90,
          type: 'vivienda',
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: 'Villa con parcela Marbella',
          price: 350000,
          market: 650000,
          surface: 200,
          type: 'vivienda',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Piso céntrico rehabilitar',
          price: 45000,
          market: 95000,
          surface: 75,
          type: 'vivienda',
        ...
        {
          title: 'Nave industrial polígono Argales',
          price: 80000,
          market: 150000,
          surface: 300,
          type: 'nave',
...
export async function getAuctionOpportunities(
  ...
  if (live.length > 0) {
    return provinces.length > 0
      ? live.filter(
          (a) =>
            provinces.some((p) => a.location.toLowerCase().includes(p.toLowerCase())) ||
            a.location === 'España'
        )
      : live;
  }
...
async function getIdealistaOpportunities(): Promise<MarketOpportunity[]> {
  ...
  try {
    const { getIdealistaDataReport, getZonePriceIndex, getRentalYield } =
      ...
      for (const zone of report?.subZones || salePrices) {
        ...
        results.push({
          ...
          tags: [
            ...
            'infravalorado',
            city.toLowerCase(),
            ...(zone.location ? [zone.location.toLowerCase()] : []),
          ],
        });
      }
...
async function getAlertaSubastasOpportunities(provinces?: string[]): Promise<MarketOpportunity[]> {
  try {
    const { scrapeAlertaSubastas, isAlertaSubastasConfigured } =
      await import('@/lib/alertasubastas-service');
    ...
    return items.map((item) => ({
      ...
      estimatedYield:
        item.marketValue > 0 && item.price > 0
  ...
  const banks = [
    {
      ...
      items: [
        {
          title: 'Lote 5 pisos zona sur Madrid',
          price: 450000,
          market: 680000,
          surface: 350,
          type: 'edificio',
        ...
        {
          title: 'Promoción sin terminar Alicante',
          price: 280000,
          market: 500000,
          surface: 400,
          type: 'vivienda',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Vivienda nueva Costa del Sol',
          price: 165000,
          market: 240000,
          surface: 90,
          type: 'vivienda',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Chalet adosado Valladolid',
          price: 110000,
          market: 175000,
          surface: 140,
          type: 'vivienda',
    ...
    },
    {
      ...
      items: [
        {
          title: 'Edificio 8 viviendas Barcelona',
          price: 1200000,
          market: 1800000,
          surface: 600,
          type: 'edificio',
        ...
        {
          title: 'Oficinas zona empresarial Madrid',
          price: 320000,
          market: 480000,
          surface: 200,
          type: 'oficina',
        ...
        {
          title: 'Local con inquilino Sevilla',
          price: 95000,
          market: 145000,
          surface: 70,
          type: 'local',
  ...
  return [
    {
      ...
      riskLevel: 'medio',
      description:
        'Mayor proyecto urbanístico de Europa: 10.500 viviendas, 4 rascacielos. Zona a €3.500/m², previsión €4.500-5.000/m² al completar (2028-2030).',
    ...
    },
    {
      ...
      riskLevel: 'bajo',
      description:
        'Distrito de innovación con Amazon, Microsoft, Meta. Alquiler oficinas: €18-25/m²/mes.',
  ...
  return [
    {
      ...
      riskLevel: 'alto',
      description:
        'Crowdfunding regulado CNMV. Inversión mínima: €50.000. TIR objetivo: 12.5% a 24 meses.',
    ...
    },
    {
      ...
      riskLevel: 'alto',
      description:
        'Crowdfunding regulado CNMV. Inversión desde €10.000. Rentabilidad: 9.8% anual, 36 meses.',
      url: 'https://wecity.io',
...
export async function getAllMarketOpportunities(
  provinces?: string[]
): Promise<OpportunitiesBySource> {
  ...
  const [boeAuctions, alertaSubastas, idealistaOpps] = useLiveSources
    ? await Promise.all([
        getAuctionOpportunities(provinces || []).catch((e) => {
          ...
          return getBOEFallbackAuctions(
            provinces || ['Madrid', 'Barcelona', 'Valencia', 'Málaga', 'Valladolid']
          );
        }),
  ...
  const uniqueAlerta = alertaSubastas.filter(
    (a) => !seenTitles.has(a.title.substring(0, 30).toLowerCase())
  );
