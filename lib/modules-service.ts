...
export const MODULOS_CATALOGO = [
  // === MÓDULOS CORE (Siempre activos) ===
  {
    ...
    ruta: '/dashboard',
    requiereModulos: [],
    tiersIncluido: ['STARTER', 'PROFESSIONAL', 'BUSINESS', 'ENTERPRISE'],
    esCore: true,
    orden: 1,
  },
  {
  ...
  },
  {
    ...
    ruta: '/proveedores',
    requiereModulos: [],
    tiersIncluido: ['PROFESSIONAL', 'BUSINESS', 'ENTERPRISE'],
    esCore: false,
    orden: 12,
  },
  {
  ...
  },
  {
    ...
    tiersIncluido: ['BUSINESS', 'ENTERPRISE'],
    esCore: false,
    orden: 21,
  },
  {
  ...
  // ============================================
  {
    ...
    descripcion:
      'Gestión integral de oficinas, locales comerciales, naves industriales y espacios de coworking. Incluye contratos comerciales LAU, CAM, escalado de rentas, licencias de actividad y gestión de leads.',
    categoria: 'vertical',
    icono: 'Building2',
    ruta: '/comercial',
    requiereModulos: ['edificios'],
  ...
  },
  {
    ...
    descripcion:
      'Conexión directa con cuentas bancarias vía Redsys/GoCardless para cobros y conciliación',
    categoria: 'financiero',
    icono: 'Landmark',
    ruta: '/open-banking',
    requiereModulos: ['pagos'],
  ...
  },
  {
    ...
    descripcion:
      'Certificados energéticos, cédulas de habitabilidad, licencias y cumplimiento normativo',
    categoria: 'gestion',
    icono: 'Award',
  ...
  },
  {
    ...
    descripcion:
      'Creación, asignación y seguimiento de órdenes de trabajo para mantenimiento y reparaciones',
    categoria: 'gestion',
    icono: 'Wrench',
  ...
  },
  {
    ...
    descripcion:
      'Digitalización automática de facturas y documentos con reconocimiento óptico (OCR)',
    categoria: 'avanzado',
    icono: 'Scan',
    ruta: '/ocr',
    requiereModulos: ['documentos'],
  ...
  // Hospitality
  {
    ...
    nombre: 'Hospitality',
    descripcion:
      'Gestión de apart-hotels, B&B y serviced apartments con check-in/out y servicios al huésped',
    categoria: 'gestion',
    icono: 'Hotel',
    ruta: '/hospitality',
    requiereModulos: ['edificios'],
  ...
  // Holding / Grupo Societario
  {
    ...
    descripcion:
      'Consolidación de sociedades patrimoniales, análisis de inversiones, comparativa, hipotecas y fiscal del grupo',
    categoria: 'financiero',
    icono: 'Crown',
    ruta: '/inversiones',
    requiereModulos: [],
  ...
  // Matching Inteligente
  {
    ...
    descripcion:
      'Algoritmos de emparejamiento inquilino-propiedad basados en preferencias y scoring',
    categoria: 'avanzado',
    icono: 'UserCheck',
    ruta: '/matching',
    requiereModulos: ['inquilinos', 'unidades'],
  ...
  // IA Documental
  {
    ...
    descripcion:
      'Procesamiento inteligente de documentos con OCR e IA para extracción automática de datos',
    categoria: 'avanzado',
    icono: 'Bot',
  ...
  // ============================================
  {
    ...
    descripcion:
      'Marketplace de profesionales de construcción y mantenimiento: trabajadores, asignaciones, obras, pagos y compliance',
    categoria: 'vertical',
    icono: 'Users2',
    ruta: '/ewoorker',
    requiereModulos: [],
  ...
  },
  {
    ...
    descripcion:
      'Gestión de promociones inmobiliarias: proyectos, ventas, marketing y comercialización',
    categoria: 'vertical',
    icono: 'Building2',
  ...
  },
  {
    ...
    descripcion:
      'Residencias de estudiantes: habitaciones, residentes, aplicaciones, actividades y pagos',
    categoria: 'vertical',
    icono: 'Home',
  ...
  },
  {
    ...
    descripcion:
      'Valoración automática de propiedades con inteligencia artificial y datos del mercado',
    categoria: 'avanzado',
    icono: 'Brain',
    ruta: '/valoracion-ia',
    requiereModulos: ['edificios'],
  ...
  },
  {
    ...
    descripcion:
      'Gestión integral de comunidades de propietarios: cuotas, actas, votaciones, incidencias y más',
    categoria: 'vertical',
    icono: 'Building2',
    ruta: '/comunidades',
    requiereModulos: ['edificios'],
 ...
 */
/**
 * PLANES DE SUSCRIPCIÓN - SINCRONIZADOS CON LANDING /landing/precios
 *
 * 4 planes públicos: Starter €35, Profesional €59, Business €129, Enterprise €299
 * 1 plan interno: Owner €0 (acceso total, solo para propietarios de la plataforma)
 */
export const SUBSCRIPTION_PACKS = [
  ...
  {
    tier: 'ENTERPRISE', // Owner usa tier ENTERPRISE pero es interno
    nombre: 'Owner',
    ...
    maxPropiedades: 9999,
    modulosIncluidos: MODULOS_CATALOGO.map((m) => m.codigo), // Todos los módulos
    esInterno: true, // No visible en landing ni seleccionable por usuarios externos
    caracteristicas: [
...
export async function getActiveModulesForCompany(companyId: string): Promise<string[]> {
  ...
  const deactivatedModules = new Set(
    companyModules.filter((m) => !m.activo).map((m) => m.moduloCodigo)
  );
  ...
  const finalModules = Array.from(new Set(allModules)).filter((m) => !deactivatedModules.has(m));
