...
- ✅ **Escenario alquiler turístico / de temporada** (Mashvisor/AirDNA): ADR × ocupación, costes de plataforma/gestión/limpieza, amueblado y comparación con el alquiler tradicional.
- ✅ **AVM hedónico** (Tinsa/uDA/Zestimate): ajuste del ARV por planta, ascensor, antigüedad y tamaño.
- ✅ **Mapa de calor** de rentabilidad y descuento por zona (Mashvisor).

### Roadmap prioritario
1. **Datos reales de ADR/ocupación por zona** para el STR (integrar AirDNA o fuente equivalente).
2. **AVM avanzado** con transacciones reales (Registradores) y más variables.
3. **Verificación en producción** del formato de BOE y del emparejamiento por dirección en Catastro.
