    ...
    <div className="flex h-screen overflow-hidden bg-gradient-bg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-500">{securityData?.summary.critical || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-500">{securityData?.summary.high || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-500">{securityData?.summary.medium || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-500">{securityData?.summary.low || 0}</div>
            ...
            <div className="space-y-2">
              {(securityData?.summary?.critical || 0) > 0 && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Se recomienda revisar inmediatamente las alertas críticas y tomar medidas correctivas.
                  </AlertDescription>
                </Alert>
              )}
              {(securityData?.summary?.high || 0) > 5 && (
                <Alert>
                  ...
                  <AlertDescription>
                    Considera implementar controles de seguridad adicionales o revisar las políticas de acceso.
                  </AlertDescription>
                </Alert>
              )}
            </div>
