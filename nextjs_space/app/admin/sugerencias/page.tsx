        ...
        {suggestions.length === 0 ? (
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-600">No hay sugerencias con los filtros seleccionados</p>
            </CardContent>
          </Card>
        ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500">
                      ...
                      <span>•</span>
                      <span>
                        {format(new Date(suggestion.createdAt), 'dd MMM yyyy', { locale: es })}
                      </span>
                    </div>
                  </div>
          ...
          {selectedSuggestion && (
            <div className="space-y-4">
              <div className="flex gap-2">
                ...
                <Badge variant="outline">{selectedSuggestion.categoria.replace('_', ' ')}</Badge>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mt-1">
                  {format(new Date(selectedSuggestion.createdAt), "dd 'de' MMMM 'de' yyyy 'a las' HH:mm", { locale: es })}
                </p>
              </div>
              ...
              {selectedSuggestion.respuesta && selectedSuggestion.fechaRespuesta && (
                <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                  ...
                  <p className="text-sm text-green-800 mt-1">{selectedSuggestion.respuesta}</p>
                  <p className="text-xs text-green-600 mt-2">
                    {format(new Date(selectedSuggestion.fechaRespuesta), "dd/MM/yyyy 'a las' HH:mm", { locale: es })}
                  </p>
                </div>
              )}
