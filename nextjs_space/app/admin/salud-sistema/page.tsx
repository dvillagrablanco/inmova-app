...
import { RefreshCw, Activity, AlertTriangle, CheckCircle, XCircle, Server, Database, Users, Building } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-gradient-bg">
          ...
          <div className="flex items-center gap-4">
            {healthData?.status === 'healthy' ? (
              <>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Última actualización: {healthData.timestamp && new Date(healthData.timestamp).toLocaleString()}
                  </p>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  <p className="text-2xl font-bold text-yellow-500">Advertencias Detectadas</p>
                  <p className="text-sm text-muted-foreground">
                    Última actualización: {healthData?.timestamp && new Date(healthData.timestamp).toLocaleString()}
                  </p>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{healthData?.metrics.totalCompanies || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{healthData?.metrics.totalBuildings || 0}</div>
      ...
      {healthData?.companiesWithIssues && healthData.companiesWithIssues.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Empresas que requieren atención inmediata
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              {healthData.companiesWithIssues.map((company) => (
                ...
                >
                  ...
                  <Badge
                    variant={company.subscriptionStatus === 'INACTIVE' ? 'destructive' : 'secondary'}
                  >
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <p className="text-lg font-semibold">
                {healthData?.system.memoryUsage ? formatBytes(healthData.system.memoryUsage.heapUsed) : 'N/A'} / {healthData?.system.memoryUsage ? formatBytes(healthData.system.memoryUsage.heapTotal) : 'N/A'}
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold">{healthData?.system.nodeVersion || 'N/A'}</p>
            </div>
            <div>
            ...
            {healthData?.database.status === 'healthy' ? (
              <>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">La base de datos está funcionando correctamente</p>
                </div>
              </>
            ) : (
              <>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">No se puede conectar a la base de datos</p>
                </div>
              </>
            )}
          </div>
        ...
        <Card>
          ...
          <CardContent>
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Se detectaron {healthData.metrics.failedLogins} intentos de login fallidos en las últimas 24 horas.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
