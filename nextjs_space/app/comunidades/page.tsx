    ...
    <div className="flex h-screen overflow-hidden bg-gradient-bg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {modulos.map((modulo) => {
          ...
          return (
            ...
            >
              <CardHeader>
                <div className={`w-12 h-12 rounded-lg ${modulo.bgColor} flex items-center justify-center mb-2`}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visión global de la gestión de comunidades
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="overview" className="w-full">
            ...
            <TabsContent value="renovaciones" className="space-y-4 mt-4">
              <p className="text-sm text-muted-foreground">
                Dashboard de renovaciones inteligentes disponible en el módulo correspondiente.
              </p>
