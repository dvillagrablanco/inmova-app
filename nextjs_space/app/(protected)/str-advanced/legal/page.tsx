...
export default function LegalCompliancePage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'vigente': return <Badge variant="default">Vigente</Badge>;
      case 'proximo_vencimiento': return <Badge variant="destructive">Próximo a Vencer</Badge>;
      case 'sin_licencia': return <Badge variant="secondary">Sin Licencia</Badge>;
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">Gestión de licencias y regulación turística</p>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center text-muted-foreground p-8">
                ...
                <p className="text-sm mt-2">Genera y envía automáticamente los partes ante las autoridades</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
                ...
                <Card className="border-2">
                  <CardContent className="pt-6">
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      <div>
                        <span className="text-muted-foreground text-sm block">Tasa por Noche</span>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center text-muted-foreground p-8">
                ...
                <p className="text-sm mt-2">Almacena y gestiona toda la documentación necesaria</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
