...
export default function RevenueManagementPage() {
  ...
  const [strategies, setStrategies] = useState([
    ...
    { id: '2', name: 'Last Minute', type: 'last_minute', active: true, listings: 12, avgIncrease: -10 },
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex items-center text-xs text-green-600 mt-1">
                  ...
                  +{revenueData.monthlyGrowth}% vs mes anterior
                </div>
              </CardContent>
            </Card>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-3 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <p className="font-medium capitalize">{strategy.type.replace('_', ' ')}</p>
                            </div>
                            <div>
                              <span className="text-muted-foreground">Ajuste Promedio</span>
                              <p className={`font-medium ${strategy.avgIncrease > 0 ? 'text-green-600' : 'text-red-600'}`}>
                                {strategy.avgIncrease > 0 ? '+' : ''}{strategy.avgIncrease}%
                              </p>
                            </div>
                          </div>
                        </div>
        ...
        <TabsContent value="pricing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Calcula el precio óptimo basado en múltiples factores</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="bg-muted p-8 rounded-lg text-center text-muted-foreground">
