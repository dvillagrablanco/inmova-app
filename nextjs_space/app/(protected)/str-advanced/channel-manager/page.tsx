...
export default function ChannelManagerPage() {
  ...
  const [channels, setChannels] = useState([
    ...
    { id: '2', name: 'Booking.com', status: 'conectado', lastSync: '2024-12-06T10:25:00', bookings: 8 },
  ...
  const exportCalendar = async (listingId: string) => {
    try {
      const response = await fetch(`/api/str-advanced/channel-manager/export-ical?listingId=${listingId}`);
    ...
    <div className="flex h-screen overflow-hidden bg-gradient-bg">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-muted-foreground">Gestión unificada de canales de distribución</p>
          </div>
              ...
              <div className="space-y-3">
                ...
                {channel.lastSync && (
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    ...
                    <span>Última sync: {new Date(channel.lastSync).toLocaleTimeString()}</span>
                  </div>
                )}
                <Button
                  size="sm"
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Vista consolidada de todas las reservas de todos los canales</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="bg-muted p-8 rounded-lg text-center text-muted-foreground">
            ...
            <p className="text-sm">Mostrando sincronización en tiempo real de todos los canales</p>
          </div>
        </CardContent>
      </Card>
