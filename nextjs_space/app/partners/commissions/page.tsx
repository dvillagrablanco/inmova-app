          ...
          {filteredComisiones.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              {filteredComisiones.map((com: any) => {
                ...
                return (
                  <div key={com.id} className="p-4 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-100 text-xs text-gray-500 grid grid-cols-2 gap-2">
                      <div>
                        Clientes activos: <span className="font-medium">{com.clientesActivos}</span>
                      </div>
                      <div>
                        Creada: <span className="font-medium">{new Date(com.createdAt).toLocaleDateString('es-ES')}</span>
                      </div>
                      {com.fechaPago && (
                        <div className="col-span-2 text-green-600">
                          Pagada el: <span className="font-medium">{new Date(com.fechaPago).toLocaleDateString('es-ES')}</span>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Las comisiones se calculan automáticamente cada mes según el número de clientes activos que tengas. 
