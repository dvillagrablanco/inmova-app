                ...
                <div className="space-y-4">
                  <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4">
                    ...
                    <p className="text-3xl font-bold text-red-700">
                      €{hommingPriceWithVAT.toLocaleString('es-ES')}
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Revisa punto por punto dónde INMOVA supera a Homming
            </p>
          </div>
              ...
              <ComparisonTable
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    homming: 'Problemas reportados',
                    inmova: 'PWA + Nativa',
                  },
                  {
                    feature: 'Onboarding Incluido',
                    homming: '1-5h según plan',
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  '88 módulos profesionales vs 15 funcionalidades básicas. INMOVA hace mucho más.',
              ...
              },
              {
                ...
                description:
                  'Te ayudamos gratis con la migración. 60 días de prueba. Garantía de satisfacción.',
                color: 'text-pink-600',
                bg: 'bg-pink-50',
              },
            ].map((reason, index) => (
            ...
            {[
              {
                ...
                quote:
                  'Pagaba €139/mes en Homming. Ahora con INMOVA pago €60/mes y tengo TODO: STR, coliving, IA... La decisión más inteligente de 2024.',
                savings: '€948/año',
              },
              {
                name: 'Laura Martínez',
                ...
                quote:
                  'Homming se nos quedó pequeño. INMOVA tiene blockchain para tokenizar, multi-empresa, API completa. Otro nivel completamente.',
                savings: '€2,000+/año',
              },
              {
                name: 'Antonio López',
                ...
                quote:
                  'Necesitábamos White Label y API robusta. Homming cobraba €279/mes. INMOVA nos da más por €100/mes. Plus: soporte excepcional.',
                savings: '€2,148/año',
              },
