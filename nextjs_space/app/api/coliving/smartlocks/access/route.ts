...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error en GET /api/coliving/smartlocks/access:', error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error en POST /api/coliving/smartlocks/access:', error);
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error en DELETE /api/coliving/smartlocks/access:', error);
    return NextResponse.json(
