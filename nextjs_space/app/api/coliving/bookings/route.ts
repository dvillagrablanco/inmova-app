...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error en GET /api/coliving/bookings:', error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error en POST /api/coliving/bookings:', error);
    return NextResponse.json(
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    console.error('Error en PATCH /api/coliving/bookings:', error);
    return NextResponse.json(
