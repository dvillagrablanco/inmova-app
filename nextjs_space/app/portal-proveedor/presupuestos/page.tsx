      ...
      <Card className="mb-6">
        <CardContent className="pt-6">
          <div className="flex flex-col sm:flex-row gap-4 justify-between">
            ...
            <Button onClick={() => router.push('/portal-proveedor/presupuestos/nuevo')} className="gap-2">
      ...
      <div className="grid gap-4 md:grid-cols-3 mb-6">
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Total Presupuestado</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Presupuestos Aceptados</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">Pendientes de Respuesta</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">
                    ...
                    <TableRow key={quote.id}>
                      ...
                      <TableCell className="text-right">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => router.push(`/portal-proveedor/presupuestos/${quote.id}`)}
                        >
