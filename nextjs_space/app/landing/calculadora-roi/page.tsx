...
import { 
  Building2, Calculator, TrendingDown, TrendingUp, CheckCircle, 
  DollarSign, AlertCircle, Download, ArrowRight, Sparkles,
  Zap, Shield, Star, Users
} from 'lucide-react';
      ...
      <section className="pt-32 pb-12 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-4 max-w-3xl mx-auto">
            Compara tu coste actual con INMOVA y descubre el <strong className="text-indigo-600">ahorro real</strong> en tu gestión inmobiliaria.
          </p>
            ...
            <Card className="bg-white shadow-2xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <Label className="text-lg font-semibold">Servicios Adicionales que Necesitas</Label>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">• Herramientas de mantenimiento (~€30/mes)</p>
              ...
              <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-red-200 shadow-xl">
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between items-center pb-2 border-b border-red-200">
                    ...
                    <span className="font-semibold text-gray-900">€{costActual.software.toFixed(2)}</span>
                  </div>
                  {costActual.channelManager && (
                    <div className="flex justify-between items-center pb-2 border-b border-red-200">
                      <span className="text-gray-700">Channel Manager (STR):</span>
                      <span className="font-semibold text-gray-900">€{costActual.channelManager.toFixed(2)}</span>
                    </div>
                  )}
                  {costActual.digitalSignature && (
                    <div className="flex justify-between items-center pb-2 border-b border-red-200">
                      <span className="text-gray-700">Firma Digital:</span>
                      <span className="font-semibold text-gray-900">€{costActual.digitalSignature.toFixed(2)}</span>
                    </div>
                  )}
                  {costActual.crm && (
                    <div className="flex justify-between items-center pb-2 border-b border-red-200">
                      <span className="text-gray-700">CRM:</span>
                      <span className="font-semibold text-gray-900">€{costActual.crm.toFixed(2)}</span>
                    </div>
                  )}
                  <div className="flex justify-between items-center pb-2 border-b border-red-200">
                    <span className="text-gray-700">Mantenimiento:</span>
                    <span className="font-semibold text-gray-900">€{costActual.maintenance?.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between items-center pb-2 border-b border-red-200">
                    <span className="text-gray-700">Soporte:</span>
                    <span className="font-semibold text-gray-900">€{costActual.support?.toFixed(2)}</span>
                  </div>
                  ...
                  <div className="pt-3 mt-3 border-t-2 border-red-300">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-3xl font-extrabold text-red-700">€{costActual.total.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center mt-2">
                      <span className="text-sm text-gray-600">Total Anual:</span>
                      <span className="text-lg font-semibold text-red-600">€{(costActual.total * 12).toFixed(2)}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-white/60 rounded-lg p-4 space-y-2">
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span>Software completo (88 módulos)</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-lg p-4 text-white">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-2xl font-extrabold">€{costInmovaConDescuento.toFixed(2)}</span>
                      </div>
              ...
              <Card className="bg-gradient-to-br from-indigo-600 to-violet-600 border-0 shadow-2xl text-white">
                ...
                <CardContent className="space-y-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                    ...
                    <p className="text-5xl font-extrabold text-yellow-300 mb-1">€{ahorroAnual.toFixed(2)}</p>
                    <p className="text-sm text-indigo-200">€{(ahorroAnual / 12).toFixed(2)} / mes</p>
                  </div>
                  ...
                  <div className="bg-yellow-400 text-gray-900 rounded-lg p-6 text-center border-4 border-yellow-300">
                    ...
                    <p className="text-6xl font-black mb-1">€{ahorroAnualConDescuento.toFixed(2)}</p>
                    <p className="text-sm font-semibold text-yellow-800">¡Ahorra más de {Math.round((ahorroAnualConDescuento / costActual.total / 12) * 100)}% en el primer año!</p>
                  </div>
                  ...
                  <div className="space-y-2 text-indigo-100">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>Recuperas el coste de cambio en {Math.ceil(500 / (ahorroAnual / 12))} meses</span>
                    </div>
                    <div className="flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-gradient-to-br from-indigo-50 to-blue-50">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 italic mb-4">
                  "Pasé de pagar €420/mes entre Homming y Guesty a solo €199 con INMOVA. Y tengo MU CHAS más funcionalidades. El ROI fue inmediato."
                </p>
                <p className="font-semibold text-gray-900">Carlos M. - Agencia PropTech, 85 unidades</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-violet-50 to-purple-50">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 italic mb-4">
                  "La calculadora me convenció. Estaba tirando €3,800 al año en herramientas dispersas. Con INMOVA todo está en un solo lugar y ahorro casi €2,000 anuales."
                </p>
                <p className="font-semibold text-gray-900">Laura R. - Inversora Individual, 32 unidades</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-indigo-600 to-violet-600">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
            Únete a los <strong className="text-white">cientos de gestores inmobiliarios</strong> que ya están ahorrando miles de euros al año con INMOVA.
          </p>
