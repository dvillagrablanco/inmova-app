        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
              Revolucionando la
              <span className="bg-gradient-to-r from-indigo-600 via-violet-600 to-pink-600 bg-clip-text text-transparent"> Gestión Inmobiliaria</span>
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed">
              INMOVA es la plataforma PropTech líder en España, diseñada para unificar todos los modelos de negocio inmobiliario en una sola solución integral.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-2 border-indigo-200 bg-white">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  Eliminar la fragmentación tecnológica del sector inmobiliario, proporcionando una plataforma única que integra 88 módulos profesionales y 7 verticales de negocio, permitiendo a las gestoras reducir sus costes de software en un 70% y aumentar su ROI en un 25%.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-violet-200 bg-white">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  Convertirnos en la plataforma PropTech de referencia en Europa, impulsando la transformación digital del sector inmobiliario mediante tecnologías de vanguardia como IA, Blockchain, IoT y automatización inteligente.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Zap, title: 'Innovación Constante', desc: 'Siempre a la vanguardia tecnológica, integrando las últimas tendencias PropTech.' },
              { icon: Users, title: 'Cliente Primero', desc: 'Escuchamos activamente a nuestros usuarios para evolucionar según sus necesidades reales.' },
              { icon: Award, title: 'Excelencia Operativa', desc: 'Compromiso con la calidad, el uptime del 99.9% y el soporte excepcional.' },
              { icon: TrendingUp, title: 'Crecimiento Sostenible', desc: 'Desarrollo responsable que beneficia a clientes, equipo y medio ambiente.' },
              { icon: Heart, title: 'Transparencia Total', desc: 'Comunicación clara, precios justos y sin costes ocultos.' },
              { icon: Rocket, title: 'Agilidad y Eficiencia', desc: 'Optimizamos procesos para que nuestros clientes sean más productivos.' }
            ].map((valor, i) => (
          ...
          <Card className="border-2">
            <CardContent className="p-8">
              <p className="text-lg text-gray-700 leading-relaxed text-center">
                INMOVA es desarrollado por <strong>Enxames Investments SL</strong>, una empresa especializada en soluciones tecnológicas para el sector inmobiliario. Nuestro equipo multidisciplinar combina experiencia en desarrollo de software, gestión inmobiliaria, inteligencia artificial y blockchain para crear la plataforma PropTech más completa del mercado.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Únete a las 500+ empresas que ya confían en INMOVA para gestionar su negocio inmobiliario
          </p>
