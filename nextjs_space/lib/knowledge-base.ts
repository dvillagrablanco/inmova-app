...
export const faqs: FAQ[] = [
  {
    ...
    answer: 'Primero completa tu perfil de empresa, luego añade tu primer edificio con sus unidades. Después, podrás registrar inquilinos y crear contratos. Te recomendamos seguir nuestro tour de onboarding que te guiará paso a paso.',
    category: 'Onboarding',
  ...
  },
  {
    ...
    answer: 'Sí, INMOVA permite importar datos desde Excel o CSV. Ve a Configuración > Importación de datos y sigue las instrucciones. También ofrecemos servicio de migración asistida para grandes volúmenes de datos.',
  ...
  },
  {
    ...
    answer: 'Sí, absolutamente. Los contratos firmados digitalmente en INMOVA tienen la misma validez legal que los manuscritos según la normativa europea eIDAS. Cada firma incluye certificado con timestamp y es admisible como prueba en tribunales.',
    category: 'Contratos',
  ...
  },
  {
    ...
    answer: 'Puedes configurar pagos recurrentes mensuales vinculados a cada contrato. El sistema generará automáticamente los cargos, enviará recordatorios al inquilino y registrará el pago cuando se complete. Soporta domiciliación bancaria, tarjeta y transferencias.',
    category: 'Pagos',
  ...
  },
  {
    ...
    answer: 'El sistema de INMOVA incluye gestión automatizada de morosidad: 1) Alertas tempranas de riesgo, 2) Recordatorios automáticos escalonados, 3) Bloqueo de acceso al portal, 4) Generación de documentación legal, 5) Gestión de procesos de cobro.',
    category: 'Morosidad',
  ...
  },
  {
    ...
    answer: 'Sí, INMOVA está diseñado para gestionar desde 1 hasta miles de propiedades. Puedes organizar tus edificios por zonas, crear grupos, aplicar filtros avanzados y generar reportes consolidados o individuales.',
    category: 'Edificios',
  ...
  },
  {
    ...
    answer: 'Sí, cada inquilino recibe acceso a su portal personal donde puede: ver su contrato, descargar recibos, reportar incidencias, comunicarse contigo, y solicitar servicios del marketplace. Todo desde su móvil o computadora.',
    category: 'Portal Inquilino',
  ...
  },
  {
    ...
    answer: 'Los inquilinos pueden reportar incidencias desde su portal con fotos, descripción y prioridad. El sistema categoriza automáticamente, asigna a un proveedor de tu red, y envía notificaciones de progreso. Tú mantienes control total del proceso.',
    category: 'Mantenimiento',
  ...
  },
  {
    ...
    answer: 'INMOVA incluye más de 50 tipos de reportes: financieros (ingresos, gastos, ROI), operativos (ocupación, rotación), de morosidad, mantenimiento, y más. Puedes exportarlos en Excel o PDF y programar envíos automáticos por email.',
    category: 'Reportes',
  ...
  },
  {
    ...
    answer: 'Totalmente seguro. Usamos cifrado de grado bancario, backups diarios automáticos, autenticación de dos factores, y cumplimos estrictamente con GDPR. Nuestros servidores están en Europa y auditados regularmente.',
    category: 'Seguridad',
  ...
  },
  {
    ...
    answer: 'Sí, puedes usar nuestras plantillas predefinidas (que cumplen toda la normativa) y personalizarlas añadiendo o modificando cláusulas. También puedes crear tus propias plantillas desde cero para reutilizarlas.',
    category: 'Contratos',
  ...
  },
  {
    ...
    answer: 'El marketplace conecta a tus inquilinos con servicios adicionales (limpieza, reparaciones, seguros). Tú ganas una comisión por cada servicio contratado, aumentas la satisfacción del inquilino, y todo se gestiona desde INMOVA.',
    category: 'Marketplace',
  ...
  },
  {
    ...
    answer: 'Sí, INMOVA incluye un módulo completo para alquiler por habitaciones con: contratos individuales, prorrateo automático de gastos, calendarios de limpieza, reglas de convivencia, y comunicación grupal.',
    category: 'Habitaciones',
  ...
  },
  {
    ...
    answer: 'No, INMOVA no tiene límites. Puedes añadir tantos edificios, unidades, inquilinos y usuarios del equipo como necesites. El precio se ajusta según el volumen, contacta con ventas para planes enterprise.',
    category: 'Pricing',
  ...
  },
  {
    ...
    answer: 'Sí, incluimos: 1) Tour interactivo al registrarte, 2) Base de conocimiento con guías y videos, 3) Chatbot IA 24/7, 4) Soporte por email, 5) Webinars mensuales, 6) Formación personalizada para planes enterprise.',
    category: 'Soporte',
  ...
  },
  {
    ...
    answer: 'Sí, puedes configurar recordatorios automáticos que se envían X días antes del vencimiento, el día del vencimiento, y X días después. Los recordatorios se envían por email, SMS o WhatsApp según tu configuración.',
    category: 'Automatización',
  ...
  },
  {
    ...
    answer: 'Nuestro módulo de BI usa IA para: predecir qué inquilinos tienen riesgo de morosidad, forecast de ingresos futuros, análisis de rotación, y optimización de precios de alquiler según el mercado. Todo basado en datos históricos.',
    category: 'BI',
  ...
  },
  {
    ...
    answer: 'Sí, INMOVA se integra con los principales software de contabilidad (Sage, ContaPlus, A3). Los movimientos se sincronizan automáticamente. También disponemos de API REST para integraciones personalizadas.',
    category: 'Integraciones',
  ...
  },
  {
    ...
    answer: 'Puedes cancelar cuando quieras sin penalización. Antes de cancelar, te permitimos exportar todos tus datos en formato Excel o CSV. Mantenemos tus datos por 90 días adicionales por si decides volver.',
    category: 'Cuenta',
  ...
  },
  {
    ...
    answer: 'Sí, INMOVA es 100% responsive y funciona perfectamente en móviles y tablets. También estamos desarrollando apps nativas para iOS y Android que estarán disponibles próximamente.',
    category: 'Plataforma',
