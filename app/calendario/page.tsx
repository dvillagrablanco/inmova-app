      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Todos los eventos del sistema en un solo lugar</p>
          </div>
        ...
        <AutoEventsBanner
          ...
          onEventsLoaded={(events) => setAutoEvents(events)}
        />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    ...
                    style={{
                      ...
                      color: 'white',
                      borderColor: PRIORIDADES.find((p) => p.value === eventoSeleccionado.prioridad)
                        ?.color,
                    }}
                  >
                    Prioridad:{' '}
