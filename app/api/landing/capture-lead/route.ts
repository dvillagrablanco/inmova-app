  ...
  try {
    ...
    if (existingLead) {
      ...
      const updatedLead = await prisma.lead.update({
        ...
        data: {
          ...
          presupuestoMensual:
            numberValue(body.presupuestoMensual) ?? existingLead.presupuestoMensual,
          numeroUnidades:
          ...
          mensajeInicial:
            stringValue(body.mensajeInicial) ||
            stringValue(body.mensaje) ||
            existingLead.mensajeInicial,
    ...
    const lead = await prisma.lead.create({
      data: {
        ...
        fuente:
          stringValue(body.fuente) || (stringValue(body.conversacionId) ? 'chatbot' : 'landing'),
