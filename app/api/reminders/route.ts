...
export async function POST(request: Request) {
  try {
    ...
    // Solo administradores y super_admin pueden ejecutar recordatorios manualmente
    ...
    return NextResponse.json({ error: 'Error ejecutando recordatorios' }, { status: 500 });
  }
}
