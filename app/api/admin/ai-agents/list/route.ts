...
const SYSTEM_AGENTS = [
  ...
  },
  {
    ...
    description: 'Analiza propuestas de cualquier tipo de activo: edificios, pisos, locales, garajes, trasteros, oficinas, naves, solares. Adapta yields, gastos y riesgos al tipo.',
    icon: 'TrendingUp',
    color: 'from-violet-500 to-purple-500',
    enabled: true,
    capabilities: [
      'Análisis adaptado por tipo: edificio, local, garaje, oficina, nave, trastero, solar',
      'Extracción automática de rent roll',
      'Yields objetivo por tipo de activo',
      'Gastos y riesgos específicos por tipo',
      'Recomendación de precio de oferta',
      'Proyecciones financieras y TIR',
      'Due diligence adaptada al tipo',
    ],
    keywords: ['rentabilidad', 'inversión', 'valoración', 'análisis', 'ROI', 'financiero', 'broker', 'rent roll', 'yield', 'propuesta', 'activo', 'edificio', 'local', 'garaje', 'parking', 'trastero', 'oficina', 'nave', 'industrial', 'solar', 'terreno', 'comercial', 'piso', 'vivienda'],
    defaultConfig: {
      model: CLAUDE_MODEL_PRIMARY,
      temperature: 0.4,
      maxTokens: 8192,
