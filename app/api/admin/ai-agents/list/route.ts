...
const SYSTEM_AGENTS = [
  ...
  },
  {
    ...
    description: 'Analiza propuestas de brokers, rent rolls, calcula yields y recomienda precios de oferta. Pega la propuesta del broker y obtén un análisis crítico.',
    icon: 'TrendingUp',
    color: 'from-violet-500 to-purple-500',
    enabled: true,
    capabilities: [
      'Análisis crítico de propuestas de brokers',
      'Extracción automática de rent roll',
      'Cálculo de yields, TIR y cash flow',
      'Gap rentas actuales vs mercado',
      'Recomendación de precio de oferta',
      'Proyecciones financieras a 10 años',
      'Due diligence checklist',
    ],
    keywords: ['rentabilidad', 'inversión', 'valoración', 'análisis', 'ROI', 'financiero', 'broker', 'rent roll', 'yield', 'propuesta', 'activo', 'edificio'],
    defaultConfig: {
      model: CLAUDE_MODEL_PRIMARY,
      temperature: 0.4,
      maxTokens: 8192,
