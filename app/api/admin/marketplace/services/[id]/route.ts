...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    logError(
      new Error(error instanceof Error ? error.message : 'Error updating marketplace service'),
      {
...
export async function DELETE(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    logError(
      new Error(error instanceof Error ? error.message : 'Error deleting marketplace service'),
      {
