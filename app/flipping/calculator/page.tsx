...
export default function FlippingCalculatorPage() {
  ...
  const cashflowData = Array.from(
    { length: data.renovationTime + data.holdingTime + 1 },
    (_, i) => {
      if (i === 0) return { month: 'Mes 0', cashflow: -(data.downPayment + data.closingCosts) };
      if (i <= data.renovationTime)
        return { month: `Mes ${i}`, cashflow: -(results.totalRenovation / data.renovationTime) };
      if (i === data.renovationTime + data.holdingTime)
        return { month: `Mes ${i}`, cashflow: results.netProfit };
    ...
    <AuthenticatedLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card
            className={`border-l-4 ${results.roi >= 20 ? 'border-l-green-500' : results.roi >= 10 ? 'border-l-yellow-500' : 'border-l-red-500'}`}
          >
            ...
            <CardContent>
              <div
                className={`text-3xl font-bold ${results.roi >= 20 ? 'text-green-600' : results.roi >= 10 ? 'text-yellow-600' : 'text-red-600'}`}
              >
          ...
          <Card className="border-l-4 border-l-blue-500">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-blue-600">{results.irr.toFixed(2)}%</div>
          ...
          <Card className="border-l-4 border-l-purple-500">
            ...
            <CardContent>
              <div
                className={`text-2xl font-bold ${results.netProfit >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField('inspectionCosts', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div className="pt-2 border-t">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-lg">
                        {formatCurrency(
                          data.purchasePrice + data.closingCosts + data.inspectionCosts
                        )}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateField('structuralWork', parseFloat(e.target.value) || 0)
                        }
                        className="h-8"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateField('landscaping', parseFloat(e.target.value) || 0)
                        }
                        className="h-8"
                      />
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField('estimatedSalePrice', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField('agentCommission', parseFloat(e.target.value) || 0)
                      }
                    />
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField('renovationTime', parseFloat(e.target.value) || 0)
                      }
                    />
                  </div>
                  <div>
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart
                      data={[
                        {
                          name: 'Adquisición',
                          value: data.purchasePrice + data.closingCosts + data.inspectionCosts,
                        },
                        ...
                        { name: 'Holding', value: results.holdingCosts },
                        {
                          ...
                          value:
                            data.sellingCosts +
                            (data.estimatedSalePrice * data.agentCommission) / 100,
                        },
                      ]}
                    >
              ...
              <CardContent className="space-y-6">
                {[
                  ...
                  const adjustedProfit =
                    adjustedSalePrice -
                    results.totalCosts +
                    (data.estimatedSalePrice - adjustedSalePrice);
                  const adjustedROI =
                    results.totalInvestment > 0
                      ? (adjustedProfit / results.totalInvestment) * 100
                      : 0;
                      ...
                      <div className="flex gap-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            El ROI proyectado es superior al 20%. Proyecto muy rentable.
                          </p>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="flex gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-700">
                            ROI aceptable. Considera optimizar costes de renovación.
                          </p>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="flex gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-700">
                            Considera negociar el precio de compra o revisar el alcance de la
                            renovación.
                          </p>
                        </div>
                      </div>
