        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-4">
              ...
              >
                <option value="mes" className="text-gray-900">
                  Este Mes
                </option>
                <option value="trimestre" className="text-gray-900">
                  Trimestre
                </option>
                <option value="ano" className="text-gray-900">
                  Año Completo
                </option>
              </select>
              <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              />
              <StatRow label="Nuevas Este Mes" value={metricas.nuevasEmpresasMes} highlighted />
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm text-purple-700">
              <p className="font-medium">
                Período actual: {metricas.mes}/{metricas.ano}
              </p>
              <p className="mt-1">
                Este panel muestra tus beneficios en tiempo real según el acuerdo 50/50. Los pagos
                se procesan automáticamente cada mes.
              </p>
            </div>
          </div>
        </div>
...
function MetricCard({ title, value, subtitle, icon, color, highlighted }: any) {
  ...
  return (
    <div
      className={`bg-gradient-to-r ${colorClasses[color]} text-white rounded-lg shadow-md p-6 ${highlighted ? 'ring-4 ring-purple-300' : ''}`}
    >
...
function StatRow({ label, value, badge, highlighted, small }: any) {
  return (
    <div
      className={`flex items-center justify-between ${small ? 'text-sm' : ''} ${highlighted ? 'font-bold' : ''}`}
    >
