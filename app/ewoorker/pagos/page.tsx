...
export default function PagosPage() {
  ...
  const getEstadoBadge = (estado: string) => {
    ...
    return (
      <span
        className={`${badge.bg} ${badge.text} px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1`}
      >
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Gestiona tu suscripción, pagos y facturación</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border rounded-lg p-6">
              ...
              <p className="text-3xl font-bold mb-4">
                €0<span className="text-sm text-gray-600">/mes</span>
              </p>
            ...
            <div className="border-2 border-blue-500 rounded-lg p-6 relative">
              ...
              <p className="text-3xl font-bold mb-4">
                €39<span className="text-sm text-gray-600">/mes</span>
              </p>
              <ul className="space-y-2 text-sm text-gray-600 mb-4">
            ...
            <div className="border rounded-lg p-6">
              ...
              <p className="text-3xl font-bold mb-4">
                €119<span className="text-sm text-gray-600">/mes</span>
              </p>
              <ul className="space-y-2 text-sm text-gray-600 mb-4">
                    ...
                    <tr key={pago.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-right">
                        <span className="text-sm font-semibold text-gray-900">
                          €
                          {(pago.montoNeto / 100).toLocaleString('es-ES', {
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          ...
                          {new Date(pago.fechaPago || pago.fechaSolicitud).toLocaleDateString(
                            'es-ES'
                          )}
                        </div>
                      </td>
