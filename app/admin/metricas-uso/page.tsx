      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Análisis de uso por módulo y empresa</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Acciones más frecuentes en el sistema</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top 20 empresas por actividad</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                metricsData.companyActivity.slice(0, 20).map((activity, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">{activity.company?.name || 'Sin empresa'}</p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top 20 usuarios por actividad</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
