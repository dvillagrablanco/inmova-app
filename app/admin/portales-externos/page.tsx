        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card className="card-hover">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">{stats.salesTeam.active} activos</p>
            </CardContent>
          </Card>
          ...
          <TabsContent value="tenants" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{stats.tenantPortal.paymentsLast30Days}</div>
          ...
          <TabsContent value="providers" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{stats.providerPortal.pendingInvoices}</div>
          ...
          <TabsContent value="owners" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{stats.ownerPortal.unreadNotifications}</div>
