...
> = {
  competidor1: {
    ...
    icon: '🏢',
    website: 'https://www.competidor1.example.com',
  },
  competidor2: {
    name: 'Competidor 2',
    description: 'Software de administración de fincas',
    icon: '🏘️',
    website: 'https://www.competidor2.example.com',
  },
  nester: {
    name: 'Nester',
  ...
  competidor3: {
    ...
    icon: '🇺🇸',
    website: 'https://www.competidor3.example.com',
  },
  appfolio: {
    name: 'AppFolio',
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">
                Importa tus datos desde Competidor 1, Competidor 2, Nester, Competidor 3, AppFolio y otros
                sistemas de gestión
              </p>
            </div>
