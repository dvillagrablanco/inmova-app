    ...
    <AuthenticatedLayout maxWidth="full">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold gradient-text">Dashboard de Superadministrador</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="border-l-4 border-l-indigo-600 bg-gradient-to-br from-indigo-50 to-white">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-indigo-700">{overview.activeCompanies}</div>
              <div className="space-y-1 mt-2">
                <div className="flex items-center text-xs">
                  <CheckCircle className="h-3 w-3 mr-1 text-green-600" />
                  <span className="text-muted-foreground">{overview.trialCompanies} en prueba</span>
                </div>
                <div className="flex items-center text-xs">
