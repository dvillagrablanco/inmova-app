      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Comparando {companies.length} empresas lado a lado</p>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-0">
              ...
              />
              <ComparisonRow label="Inquilinos" values={companies.map((c) => c.metrics.tenants)} />
              <ComparisonRow
                label="Proveedores"
              ...
              <ComparisonRow
                ...
                values={companies.map((c) => (
                  <div>
                    <div className="text-xl font-bold">{c.metrics.occupancyRate.toFixed(1)}%</div>
                    <div className="text-xs text-gray-500">
