                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div className="space-y-1">
                            ...
                            <div className="font-medium">
                              {formatDate(doc.fechaSubida, 'dd MMM yyyy')}
                            </div>
                          </div>
                          <div className="space-y-1">
                            <div className="text-muted-foreground flex items-center gap-1">
                            ...
                            {doc.fechaVencimiento ? (
                              <div className="flex items-center gap-1">
                                ...
                                >
                                  {formatDate(doc.fechaVencimiento, 'dd MMM yyyy')}
                                </span>
                              </div>
                            ) : (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium mt-1">
                    {formatDate(selectedDocument.fechaSubida, 'dd MMMM yyyy HH:mm')}
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-medium mt-1">
                    {selectedDocument.fechaVencimiento
                      ? formatDate(selectedDocument.fechaVencimiento, 'dd MMMM yyyy')
                      : 'Sin vencimiento'}
                  </p>
                </div>
              </div>
