    ...
    <AuthenticatedLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight gradient-text">Garajes y Trasteros</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Garajes</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Trasteros</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-muted-foreground">Ocupados</CardTitle>
            </CardHeader>
            <CardContent>
              ...
              return (
                <Card key={unit.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {unit.planta !== null && (
                      <div className="text-sm text-muted-foreground">Planta: {unit.planta}</div>
                    )}
                    ...
                    {unit.tenant && (
                      <div className="text-sm text-muted-foreground">
                        <span className="font-medium">Ocupado por:</span>{' '}
