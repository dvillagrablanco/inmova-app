    ...
    <AuthenticatedLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Button onClick={() => router.push('/construction')}>Volver a Proyectos</Button>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">
                {permits.filter((p) => p.status === 'approved').length} de{' '}
                {permits.filter((p) => p.required).length} obligatorios
              </Badge>
            </div>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Recuerda solicitar el Certificado de Eficiencia Energética antes del plazo
                    límite
                  </p>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        ...
                        {Math.round((phase.spent / phase.budget) * 100)}%)
                      </p>
                    </div>
                  </div>
