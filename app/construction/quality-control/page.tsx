  ...
  const [inspections] = useState<Inspection[]>([
    ...
    },
    {
      ...
      checklist: [
        ...
        {
          item: 'Forjado nivel correcto',
          status: 'warning',
          notes: 'Desnivel de 2mm en zona oeste',
        },
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div
                className={`text-2xl font-bold ${avgScore >= 80 ? 'text-green-600' : 'text-yellow-600'}`}
              >
                {avgScore}%
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">
                {
                  inspections.filter((i) => i.status === 'conditional' || i.status === 'failed')
                    .length
                }
              </div>
