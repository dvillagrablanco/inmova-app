      ...
      <div className="min-h-screen flex items-center justify-center bg-muted/30">
        <Card>
          <CardContent className="pt-6">
            ...
            <Button onClick={() => router.push('/portal-proveedor/login')} className="mt-4">
              Volver al Login
            </Button>
          </CardContent>
        </Card>
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-3xl font-bold">Portal del Proveedor</h1>
              <p className="text-muted-foreground mt-1">Bienvenido, {data.proveedor.nombre}</p>
            </div>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                  ...
                  <p className="font-medium">{data.proveedor.tipo}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Email</p>
                  <p className="font-medium">{data.proveedor.email}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Teléfono</p>
                  <p className="font-medium">{data.proveedor.telefono}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Rating</p>
                  <div className="flex items-center gap-1">
                    <Star className="h-4 w-4 fill-amber-400 text-amber-400" />
                    <span className="font-medium">{data.proveedor.rating.toFixed(1)}</span>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <Star className="h-4 w-4 fill-amber-400 text-amber-400" />
                    <span className="font-medium">{data.kpis.ratingPromedio.toFixed(1)}</span>
                  </div>
                </div>
              </div>
            </CardContent>
