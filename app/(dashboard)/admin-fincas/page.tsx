...
export default function AdminFincasPage() {
  ...
  const variacionIngresos =
    kpis && kpis.ingresosMesAnterior > 0
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Total de comunidades gestionadas</p>
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Estado de generación de informes del período actual</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium">
                      {kpis?.informesGenerados || 0} de {kpis?.totalInformes || 0} informes
                      generados
                    </p>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Link href="/admin-fincas/facturas" className="block">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">Honorarios y gastos por comunidad</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/admin-fincas/libro-caja" className="block">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">Movimientos e ingresos/gastos</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/admin-fincas/informes" className="block">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">Informes trimestrales y anuales</p>
              </CardContent>
            </Card>
          </Link>
        </div>
