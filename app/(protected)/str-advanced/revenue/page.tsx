...
export default function RevenueManagementPage() {
  ...
  const loadRevenueData = async () => {
    try {
      ...
      // const response = await fetch('/api/str/revenue');
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Optimización automática de precios e ingresos
              </p>
            </div>
                ...
                <CardContent>
                  {loading ? (
                    ...
                    <>
                      ...
                      <div className={`flex items-center text-xs ${revenueData.monthlyGrowth >= 0 ? 'text-green-600' : 'text-red-600'} mt-1`}>
                        {revenueData.monthlyGrowth >= 0 ? (
                          <ArrowUp className="h-3 w-3 mr-1" />
                        ) : (
                          <ArrowDown className="h-3 w-3 mr-1" />
                        )}
                        {Math.abs(revenueData.monthlyGrowth)}% vs mes anterior
                      </div>
                    </>
                  ) : (
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-muted p-8 rounded-lg text-center text-muted-foreground">
                  ...
                  <p>Los datos de ingresos aparecerán aquí</p>
              ...
              <CardContent>
                {loading ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold mb-2">No hay estrategias configuradas</h3>
                    <p className="text-muted-foreground mb-4">
                      Crea tu primera estrategia de pricing automático
                    </p>
                    <Button>
            ...
            <Card>
              ...
              <CardContent>
                <div className="bg-muted p-8 rounded-lg text-center text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Introduce los parámetros para calcular el precio óptimo
                  </p>
                </div>
