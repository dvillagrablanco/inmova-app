...
export default function CommonAreasPage() {
    ...
    try {
      ...
      setAreas([
        ...
        },
        {
          ...
          availability: 'available',
          rules: ['Volumen moderado después de las 22:00', 'No consumir alimentos fuertes'],
          bookable: false,
          currentOccupancy: 5,
        ...
        },
        {
          ...
          availability: 'available',
          rules: ['Reserva máxima 1 hora', 'Limpia equipos después de usar', 'Usa toalla propia'],
          bookable: true,
          currentOccupancy: 3,
  ...
  const getAvailabilityBadge = (availability: string) => {
    ...
    const {
      ...
      label,
      icon: Icon,
    } = config[availability as keyof typeof config] || config.available;
    return (
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Gestión y reservas de áreas compartidas</p>
          </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <CardDescription>Capacidad: {area.capacity} personas</CardDescription>
                          </div>
                        </div>
                      </div>
                    </CardHeader>
