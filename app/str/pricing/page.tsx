          ...
          <Card className="w-full sm:w-auto">
            <CardContent className="pt-6 flex items-center gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Ajuste diario de precios</p>
              </div>
              <Switch
                id="auto-pricing"
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-700">
                    Los precios se actualizarán automáticamente cada día a las 2:00 AM según las
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <p
                        className={`text-2xl font-bold ${getChangeColor(suggestion.changePercent)}`}
                      >
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => router.push(`/str/listings/${suggestion.listingId}`)}
                    >
                      Ver Anuncio
                    </Button>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select id="strategy" className="w-full p-2 border rounded-md">
