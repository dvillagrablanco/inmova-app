      ...
      setReviews([
        {
          ...
          rating: 5,
          comment:
            'Amazing apartment in the heart of the city! Everything was perfect, clean and exactly as described. The host was very helpful and responsive. Highly recommend!',
          date: '2025-12-20',
          responded: true,
        ...
        },
        {
          ...
          rating: 4,
          comment:
            'Great place for a family vacation. The pool was amazing and kids loved it. Only minor issue was the WiFi was a bit slow.',
          date: '2025-12-18',
          responded: false,
          categories: {
            cleanliness: 5,
        ...
        },
        {
          ...
          rating: 3,
          comment:
            'The apartment was nice but there was some street noise at night. Location is great though.',
          date: '2025-12-15',
          responded: true,
          response:
            'Thank you for your feedback Emma. We are installing better soundproofing to improve this. Hope to see you again!',
          categories: {
            cleanliness: 4,
            communication: 4,
            location: 5,
              ...
              <CardContent className="space-y-4">
                ...
                {!review.responded && (
                  <div className="pt-3 border-t">
                    <Textarea placeholder="Escribe tu respuesta..." className="mb-2" />
                    <Button
                      size="sm"
