        ...
        <div className="grid gap-4 md:grid-cols-4 mb-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">{totalConfirmadas} confirmadas</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Noches reservadas</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Pagadas a plataformas</p>
            </CardContent>
          </Card>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {booking.listing.unit.building.nombre} - Unidad{' '}
                            {booking.listing.unit.numero}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <div className="flex flex-col gap-2">
                        ...
                        <Badge className={getCanalColor(booking.canal)}>{booking.canal}</Badge>
                        {booking.pagado && (
