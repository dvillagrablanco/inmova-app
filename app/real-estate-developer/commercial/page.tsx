...
const COMERCIALES_MOCK: Comercial[] = [
  {
    id: '1',
    nombre: 'María López',
    email: 'maria.lopez@empresa.com',
    telefono: '+34 612 345 678',
    proyectosAsignados: ['Residencial Aurora', 'Torre Skyline'],
    ventasMes: 4,
    objetivoMes: 5,
    ventasAnual: 42,
    leadsPendientes: 15,
  ...
  },
  {
    ...
    proyectosAsignados: ['Jardines del Sur', 'Mirador Costa'],
    ventasMes: 3,
    objetivoMes: 4,
    ventasAnual: 28,
    leadsPendientes: 12,
  ...
  },
  {
    ...
    proyectosAsignados: ['Urban Living', 'Residencial Aurora'],
    ventasMes: 2,
    objetivoMes: 3,
    ventasAnual: 18,
    leadsPendientes: 8,
