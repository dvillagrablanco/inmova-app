                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                        ...
                        <div className="text-left md:text-right">
                          <p className="font-medium text-gray-900">€{com.montoBruto.toFixed(2)}</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800">
                  Las comisiones se calculan automáticamente cada mes según el número de clientes
                  activos que tengas. Cuantos más clientes, mayor será tu porcentaje de comisión
                  (hasta un 70%). Las comisiones se aprueban y pagan mensualmente según los términos
