      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Datos principales de tu organización como Partner</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Alert>
              <AlertDescription>
                Para modificar estos datos, por favor contacta con nuestro equipo de soporte en
                partners@inmova.com
              </AlertDescription>
            </Alert>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-3 h-4 w-4 text-gray-400" />
                  <Input id="email" value={partnerData.email} className="pl-10" disabled />
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tu esquema actual de comisiones</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <p className="text-sm text-green-800 mb-2">
                <span className="font-semibold">Comisión actual:</span>{' '}
                {partnerData.comisionPorcentaje}%
              </p>
              <p className="text-sm text-green-700">
                Tu porcentaje de comisión aumenta automáticamente según el número de clientes
                activos.
              </p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Estado actual de tu Partner</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-primary text-white">
          <CardContent className="p-6">
            ...
            <div className="space-y-2 text-sm">
              <p>
                Email:{' '}
                <a href="mailto:partners@inmova.com" className="underline font-medium">
                  partners@inmova.com
                </a>
              </p>
