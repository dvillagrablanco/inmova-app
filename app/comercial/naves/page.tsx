...
export default function NavesPage() {
  ...
  const detailHref = (n: Nave) =>
    n._source === 'unit' ? `/propiedades/${n.id}` : `/comercial/espacios/${n.id}`;
  const editHref = (n: Nave) =>
    n._source === 'unit' ? `/propiedades/${n.id}/editar` : `/comercial/espacios/${n.id}/editar`;
                ...
                <div className="flex items-start justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => router.push(detailHref(nave))}>
                        <Eye className="h-4 w-4 mr-2" />
                        Ver detalles
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => router.push(editHref(nave))}>
