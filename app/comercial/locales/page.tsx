...
export default function LocalesPage() {
  ...
  const detailHref = (l: Local) =>
    l._source === 'unit' ? `/propiedades/${l.id}` : `/comercial/espacios/${l.id}`;
  const editHref = (l: Local) =>
    l._source === 'unit' ? `/propiedades/${l.id}/editar` : `/comercial/espacios/${l.id}/editar`;
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredLocales.map((local) => {
            const ActividadIcon = local.actividad
              ? actividadIcons[local.actividad] || Store
              : Store;
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => router.push(detailHref(local))}>
                          <Eye className="h-4 w-4 mr-2" />
                          Ver detalles
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={() => router.push(editHref(local))}>
