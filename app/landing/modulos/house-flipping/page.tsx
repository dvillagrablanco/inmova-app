    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50">
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
            La única plataforma PropTech que te permite gestionar{' '}
            <strong>obras, presupuestos y ROI proyectado</strong> en un solo dashboard.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/register?coupon=LAUNCH2025">
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white text-lg h-14 px-8"
              >
            ...
            <Link href="/landing/demo?module=house-flipping">
              <Button
                size="lg"
                variant="outline"
                className="border-orange-600 text-orange-600 hover:bg-orange-50 text-lg h-14 px-8"
              >
                Ver Demo en Vivo
              </Button>
            </Link>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Precio estimado de venta después de la reforma
                  </p>
                </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pb-3 border-b border-green-200">
                    ...
                    <span className="text-lg font-semibold text-red-600">
                      -€
                      {(beneficioBruto * 0.21).toLocaleString(undefined, {
                  ...
                  <div className="flex justify-between items-center pt-3 bg-green-100 rounded-lg p-4">
                    ...
                    <span className="text-3xl font-extrabold text-green-700">
                      €{beneficioNeto.toLocaleString(undefined, { maximumFractionDigits: 0 })}
                    </span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-indigo-600 to-violet-600 border-0 shadow-2xl text-white">
                ...
                <CardContent className="space-y-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">
                    ...
                    <p className="text-6xl font-extrabold text-yellow-300 mb-1">
                      {roi.toFixed(1)}%
                    </p>
                  ...
                  {roi > 0 && (
                    <div className="space-y-2 text-indigo-100 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Margen de beneficio:{' '}
                          {((beneficioNeto / precioVentaObjetivo) * 100).toFixed(1)}%
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle className="h-4 w-4 text-green-300" />
                        <span>
                          Beneficio mensual: €
                          {(beneficioNeto / tiempoProyecto).toLocaleString(undefined, {
                            maximumFractionDigits: 0,
                          })}
                        </span>
                      </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Ve el retorno proyectado instantáneamente al introducir costes y precios.
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Control total de las 9 fases de reforma: demolición, albañilería, fontanería,
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Gestiona proveedores, presupuestos, facturas y pagos a contratistas en un solo
                  lugar.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Visualiza todos tus proyectos de flipping en paralelo: en prospección, en obra, en
                  venta.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Integración con APIs de valoración para estimar precios de mercado antes de
                  comprar.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Genera certificaciones de obra, ITE, cédulas de habitabilidad integradas en el
                  flujo.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-orange-50 to-amber-50">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-4xl font-bold text-center mb-12">¿Cómo Gestionas Flipping Ahora?</h2>
            ...
            <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-300">
              ...
              <CardContent className="space-y-3 text-sm text-gray-700">
                <div className="flex items-start gap-2">
                  ...
                  <p>
                    <strong>Calculadora ROI automática</strong> con datos en tiempo real
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <p>
                    <strong>Portal de subcontratas</strong> para comunicación centralizada
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <p>
                    <strong>Gestión de fases</strong> integrada con alertas automáticas
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <p>
                    <strong>Dashboard financiero</strong> con costes vs presupuesto
                  </p>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  <p>
                    <strong>Todo en una plataforma</strong>, sin cambiar de herramienta
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-5xl">
          <h2 className="text-3xl font-bold text-center mb-12">Flippeadores Usando INMOVA</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-gradient-to-br from-orange-50 to-amber-50">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 italic mb-4">
                  "He hecho 4 proyectos de flipping con INMOVA. El módulo de ROI me ha salvado de
                  comprar propiedades que parecían buenas pero los números no cerraban. Ahorro horas
                  en Excel."
                </p>
                <p className="font-semibold text-gray-900">
                  Javier P. - Inversor Full-Time, Barcelona
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-indigo-50 to-violet-50">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-700 italic mb-4">
                  "Gestiono 3 proyectos de flipping simultáneamente. El pipeline de INMOVA me
                  permite ver todo de un vistazo: qué fase va cada obra, los costes reales vs
                  presupuesto. Imprescindible."
                </p>
                <p className="font-semibold text-gray-900">
                  Ana L. - Arquitecta e Inversora, Madrid
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-orange-600 to-amber-600">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Con el código <strong className="text-white">LAUNCH2025</strong>, obtén 50% de descuento
            en tu primer mes y acceso completo al módulo de House Flipping.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/register?coupon=LAUNCH2025">
              <Button
                size="lg"
                className="bg-white hover:bg-gray-100 text-orange-600 font-bold text-lg h-16 px-10"
              >
