  ...
  const webinars = [
    ...
    },
    {
      ...
      temas: [
        ...
        'Tour completo por los 56 módulos de INMOVA',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50 to-violet-50">
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
            Sesiones en vivo sobre{' '}
            <strong>House Flipping, Coliving y estrategias Multi-Vertical</strong>.
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() =>
                document.getElementById('webinars-list')?.scrollIntoView({ behavior: 'smooth' })
              }
            >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 text-sm">
                  Ejemplos y números de proyectos exitosos y errores que debes evitar
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 text-sm">
                  Ve en directo cómo funcionan los módulos de INMOVA
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="pt-8">
                ...
                <p className="text-gray-600 text-sm">
                  Conecta con otros gestores e inversores inmobiliarios
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="webinars-list" className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-xl text-gray-600 text-center mb-12">
            Regístrate gratis y recibe el enlace de acceso por email
          </p>
          ...
          <div className="space-y-8">
            {webinars.map((webinar, index) => (
              <Card
                key={webinar.id}
                className={`bg-gradient-to-r ${webinar.bgColor} border-2 ${submitted && selectedWebinar === webinar.id ? 'border-green-400' : 'border-gray-200'} shadow-xl overflow-hidden`}
              >
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-2 p-6 space-y-4">
                    <div className="flex items-start gap-4">
                      <div
                        className={`p-4 bg-gradient-to-br ${webinar.color} rounded-lg flex-shrink-0`}
                      >
                    ...
                    {submitted && selectedWebinar === webinar.id ? (
                      <div className="text-center space-y-4">
                        ...
                        <p className="text-sm text-gray-700">
                          ...
                          con el enlace del webinar.
                        </p>
                        <Alert className="bg-indigo-50 border-indigo-200">
                          <Sparkles className="h-4 w-4 text-indigo-600" />
                          <AlertDescription className="text-indigo-800 text-sm">
                            Como regalo por registrarte, te enviamos un código de descuento
                            adicional para INMOVA.
                          </AlertDescription>
                        </Alert>
                      ...
                      <form onSubmit={(e) => handleSubmit(e, webinar.id)} className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`nombre-${webinar.id}`} className="text-sm font-medium">
                            Nombre Completo *
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`empresa-${webinar.id}`} className="text-sm font-medium">
                            Empresa (opcional)
                          </Label>
                          <Input
                        ...
                        <div className="space-y-2">
                          <Label htmlFor={`telefono-${webinar.id}`} className="text-sm font-medium">
                            Teléfono (opcional)
                          </Label>
                          <Input
                        ...
                        <p className="text-xs text-gray-500 text-center">
                          Al registrarte, aceptas recibir comunicaciones sobre este webinar y
                          ofertas de INMOVA.
                        </p>
                      </form>
                    )}
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-indigo-600 to-violet-600">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">Si asistes al webinar completo, recibirás:</p>
