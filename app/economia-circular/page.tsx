              ...
              <div>
                <Breadcrumb>
                  <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbPage>Economía Circular</BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
            ...
            <div className="mb-6 grid gap-4 md:grid-cols-4">
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">Items Circulares</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">Tasa Reciclaje</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">0%</div>
                </CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">CO2 Ahorrado</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm">Jardines Urbanos</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">0</div>
                </CardContent>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>EU Ecolabel y tasa de circularidad</CardDescription>
                </CardHeader>
                <CardContent>
