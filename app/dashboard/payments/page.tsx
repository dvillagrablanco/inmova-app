    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Gestiona pagos, cobros y facturación
        </p>
      </div>
        ...
        <div className="text-center py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto text-left">
            <div className="border rounded-lg p-4">
              <h3 className="font-semibold mb-2">✅ Cobros automáticos</h3>
              <p className="text-sm text-gray-600">Domiciliación bancaria</p>
            </div>
            <div className="border rounded-lg p-4">
              <h3 className="font-semibold mb-2">✅ Facturación</h3>
              <p className="text-sm text-gray-600">Facturas y recibos automáticos</p>
            </div>
            <div className="border rounded-lg p-4">
