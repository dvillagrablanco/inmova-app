...
def main():
    ...
    try:
        ...
        print(f"{Colors.CYAN}📊 Nueva Estructura de Precios:{Colors.RESET}")
        print(f"  • Starter:      €29/mes (hasta 5 propiedades)")
        print(f"  • Professional: €39/mes (hasta 25 propiedades)")
        print(f"  • Business:     €99/mes (hasta 100 propiedades)")
        print(f"  • Enterprise:   €199+/mes (ilimitadas)")
