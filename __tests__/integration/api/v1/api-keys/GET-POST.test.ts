...
describe.skip('API: /v1/api-keys', () => {
  ...
  describe.skip('GET /v1/api-keys', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/v1/api-keys`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/v1/api-keys?page=1&limit=10`;
  ...
  describe.skip('POST /v1/api-keys', () => {
