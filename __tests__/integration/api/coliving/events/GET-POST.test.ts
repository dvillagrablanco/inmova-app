...
describe.skip('API: /coliving/events', () => {
  ...
  describe.skip('GET /coliving/events', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/coliving/events`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/events?page=1&limit=10`;
  ...
  describe.skip('POST /coliving/events', () => {
