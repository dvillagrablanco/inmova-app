...
describe.skip('API: /coliving/groups', () => {
  ...
  describe.skip('GET /coliving/groups', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/coliving/groups`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/groups?page=1&limit=10`;
  ...
  describe.skip('POST /coliving/groups', () => {
