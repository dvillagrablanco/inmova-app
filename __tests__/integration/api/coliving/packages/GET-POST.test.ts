...
describe.skip('API: /coliving/packages', () => {
  ...
  describe.skip('GET /coliving/packages', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/coliving/packages`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/packages?page=1&limit=10`;
  ...
  describe.skip('POST /coliving/packages', () => {
