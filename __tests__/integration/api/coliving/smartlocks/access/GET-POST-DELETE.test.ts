...
// TODO: Este es un test de integración que requiere servidor corriendo
// Debería ejecutarse en entorno de CI/CD separado
describe.skip('API: /coliving/smartlocks/access', () => {
  ...
  describe('GET /coliving/smartlocks/access', () => {
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/smartlocks/access?page=1&limit=10`;
