...
describe.skip('API: /coliving/matches', () => {
  ...
  describe.skip('GET /coliving/matches', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/coliving/matches`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/matches?page=1&limit=10`;
  ...
  describe.skip('POST /coliving/matches', () => {
