...
describe.skip('API: /coliving/feed', () => {
  ...
  describe.skip('GET /coliving/feed', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/coliving/feed`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/coliving/feed?page=1&limit=10`;
  ...
  describe.skip('POST /coliving/feed', () => {
