...
describe.skip('API: /notification-logs', () => {
  ...
  describe.skip('GET /notification-logs', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/notification-logs`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/notification-logs?page=1&limit=10`;
  ...
  describe.skip('POST /notification-logs', () => {
