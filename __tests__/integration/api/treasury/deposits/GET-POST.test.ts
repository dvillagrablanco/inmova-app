...
describe.skip('API: /treasury/deposits', () => {
  ...
  describe.skip('GET /treasury/deposits', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/treasury/deposits`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/treasury/deposits?page=1&limit=10`;
  ...
  describe.skip('POST /treasury/deposits', () => {
