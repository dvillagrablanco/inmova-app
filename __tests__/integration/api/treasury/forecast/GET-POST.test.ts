...
describe.skip('API: /treasury/forecast', () => {
  ...
  describe.skip('GET /treasury/forecast', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/treasury/forecast`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/treasury/forecast?page=1&limit=10`;
  ...
  describe.skip('POST /treasury/forecast', () => {
