...
describe.skip('API: /treasury/alerts', () => {
  ...
  describe.skip('GET /treasury/alerts', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/treasury/alerts`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/treasury/alerts?page=1&limit=10`;
  ...
  describe.skip('POST /treasury/alerts', () => {
