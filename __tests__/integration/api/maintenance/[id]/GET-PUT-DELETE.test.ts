...
describe.skip('API: /maintenance/[id]', () => {
  ...
  describe.skip('GET /maintenance/[id]', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/maintenance/[id]`;
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/maintenance/${{testId}}`;
  ...
  describe.skip('PUT /maintenance/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/maintenance/non-existent-id`;
  ...
  describe.skip('DELETE /maintenance/[id]', () => {
