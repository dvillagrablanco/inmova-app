...
describe.skip('API: /crm/activities', () => {
  ...
  describe.skip('GET /crm/activities', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/crm/activities`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/crm/activities?page=1&limit=10`;
  ...
  describe.skip('POST /crm/activities', () => {
