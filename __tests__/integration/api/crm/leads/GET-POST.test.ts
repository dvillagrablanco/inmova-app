...
describe.skip('API: /crm/leads', () => {
  ...
  describe.skip('GET /crm/leads', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/crm/leads`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/crm/leads?page=1&limit=10`;
