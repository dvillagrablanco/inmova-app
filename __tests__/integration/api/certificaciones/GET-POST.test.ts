...
describe.skip('API: /certificaciones', () => {
  ...
  describe.skip('GET /certificaciones', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/certificaciones`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/certificaciones?page=1&limit=10`;
  ...
  describe.skip('POST /certificaciones', () => {
