...
describe.skip('API: /units/[id]', () => {
  ...
  describe.skip('GET /units/[id]', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/units/[id]`;
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/units/${{testId}}`;
  ...
  describe.skip('PUT /units/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/units/non-existent-id`;
