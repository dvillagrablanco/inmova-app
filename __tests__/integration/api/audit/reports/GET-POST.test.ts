...
describe.skip('API: /audit/reports', () => {
  ...
  describe.skip('GET /audit/reports', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/audit/reports`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/audit/reports?page=1&limit=10`;
  ...
  describe.skip('POST /audit/reports', () => {
