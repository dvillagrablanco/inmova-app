...
describe.skip('API: /suggestions', () => {
  ...
  describe.skip('GET /suggestions', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/suggestions`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/suggestions?page=1&limit=10`;
  ...
  describe.skip('POST /suggestions', () => {
