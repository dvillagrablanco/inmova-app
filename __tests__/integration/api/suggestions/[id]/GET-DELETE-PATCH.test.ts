...
describe.skip('API: /suggestions/[id]', () => {
  ...
  describe.skip('GET /suggestions/[id]', () => {
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/suggestions/${{testId}}`;
  ...
  describe.skip('DELETE /suggestions/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/suggestions/non-existent-id`;
  ...
  describe.skip('PATCH /suggestions/[id]', () => {
