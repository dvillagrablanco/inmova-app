...
describe.skip('API: /str/channels', () => {
  ...
  describe.skip('GET /str/channels', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/str/channels`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/str/channels?page=1&limit=10`;
  ...
  describe.skip('POST /str/channels', () => {
