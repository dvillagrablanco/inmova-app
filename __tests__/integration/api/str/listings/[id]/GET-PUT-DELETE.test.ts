...
describe.skip('API: /str/listings/[id]', () => {
  ...
  describe.skip('GET /str/listings/[id]', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/str/listings/[id]`;
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/str/listings/${{testId}}`;
  ...
  describe.skip('PUT /str/listings/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/str/listings/non-existent-id`;
  ...
  describe.skip('DELETE /str/listings/[id]', () => {
