...
describe.skip('API: /str/listings', () => {
  ...
  describe.skip('GET /str/listings', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/str/listings`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/str/listings?page=1&limit=10`;
  ...
  describe.skip('POST /str/listings', () => {
