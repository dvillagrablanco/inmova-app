...
describe.skip('API: /renewals/analyze', () => {
  ...
  describe.skip('GET /renewals/analyze', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/renewals/analyze`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/renewals/analyze?page=1&limit=10`;
  ...
  describe.skip('POST /renewals/analyze', () => {
