...
describe.skip('API: /incidencias', () => {
  ...
  describe.skip('GET /incidencias', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/incidencias`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/incidencias?page=1&limit=10`;
  ...
  describe.skip('POST /incidencias', () => {
