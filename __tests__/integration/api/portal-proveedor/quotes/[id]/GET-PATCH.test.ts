...
describe.skip('API: /portal-proveedor/quotes/[id]', () => {
  ...
  describe('GET /portal-proveedor/quotes/[id]', () => {
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/portal-proveedor/quotes/${{testId}}`;
  ...
  describe('PATCH /portal-proveedor/quotes/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/portal-proveedor/quotes/non-existent-id`;
