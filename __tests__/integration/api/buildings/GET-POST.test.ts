...
describe.skip('API: /buildings', () => {
  ...
  describe.skip('GET /buildings', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/buildings`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/buildings?page=1&limit=10`;
