...
describe.skip('API: /buildings/[id]', () => {
  ...
  describe.skip('GET /buildings/[id]', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/buildings/[id]`;
    ...
    it('debe manejar parámetros dinámicos', async () => {
      ...
      const url = `${baseURL}/api/buildings/${{testId}}`;
  ...
  describe.skip('PUT /buildings/[id]', () => {
    ...
    it('debe retornar 404 para recurso inexistente', async () => {
      const url = `${baseURL}/api/buildings/non-existent-id`;
  ...
  describe.skip('DELETE /buildings/[id]', () => {
