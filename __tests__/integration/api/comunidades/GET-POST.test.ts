...
describe.skip('API: /comunidades', () => {
  ...
  describe.skip('GET /comunidades', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/comunidades`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/comunidades?page=1&limit=10`;
  ...
  describe.skip('POST /comunidades', () => {
