...
describe.skip('API: /comunidades/actas', () => {
  ...
  describe.skip('GET /comunidades/actas', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/comunidades/actas`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/comunidades/actas?page=1&limit=10`;
  ...
  describe.skip('POST /comunidades/actas', () => {
