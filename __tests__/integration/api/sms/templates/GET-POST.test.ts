...
describe.skip('API: /sms/templates', () => {
  ...
  describe.skip('GET /sms/templates', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/sms/templates`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/sms/templates?page=1&limit=10`;
  ...
  describe.skip('POST /sms/templates', () => {
