...
describe.skip('API: /ewoorker/obras', () => {
  ...
  describe.skip('GET /ewoorker/obras', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/ewoorker/obras`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/ewoorker/obras?page=1&limit=10`;
  ...
  describe.skip('POST /ewoorker/obras', () => {
