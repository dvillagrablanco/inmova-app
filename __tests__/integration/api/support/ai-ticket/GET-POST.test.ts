...
describe.skip('API: /support/ai-ticket', () => {
  ...
  describe.skip('GET /support/ai-ticket', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/support/ai-ticket`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/support/ai-ticket?page=1&limit=10`;
  ...
  describe.skip('POST /support/ai-ticket', () => {
