...
describe.skip('API: /open-banking/redsys/.disabled/payments', () => {
  ...
  describe.skip('GET /open-banking/redsys/.disabled/payments', () => {
    it('debe retornar 200 con datos válidos', async () => {
      const url = `${baseURL}/api/open-banking/redsys/.disabled/payments`;
    ...
    it('debe manejar parámetros de query', async () => {
      const url = `${baseURL}/api/open-banking/redsys/.disabled/payments?page=1&limit=10`;
  ...
  describe.skip('POST /open-banking/redsys/.disabled/payments', () => {
