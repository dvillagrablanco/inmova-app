...
export const NoPaymentsIllustration: FC<IllustrationProps> = ({ className, size = 200 }) => (
  ...
  >
    ...
    <text x="140" y="105" textAnchor="middle" fill="#78350F" fontSize="16" fontWeight="bold">
      €
    </text>
    <circle
      cx="100"
...
export const NoNotificationsIllustration: FC<IllustrationProps> = ({ className, size = 200 }) => (
  ...
  >
    <path
      d="M100 50C85 50 75 60 75 75V100L65 120H135L125 100V75C125 60 115 50 100 50Z"
      fill="#E0E7FF"
    />
