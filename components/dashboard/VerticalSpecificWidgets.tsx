...
import { Building2, TrendingUp, Calendar, Users, Home, Wrench, DollarSign, Percent, Award, Clock, MapPin, Star } from 'lucide-react';
  ...
  return (
    <Card className="border-2 border-indigo-100 bg-gradient-to-br from-indigo-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Gestiona tus propiedades residenciales y comerciales
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/contratos">
            <Button variant="outline" className="w-full justify-start gap-2 hover:bg-indigo-50 hover:border-indigo-300">
  ...
  return (
    <Card className="border-2 border-purple-100 bg-gradient-to-br from-purple-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Channel Manager para Airbnb, Booking y más
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <Link href="/str/channels">
              <Button variant="outline" size="sm" className="w-full justify-start gap-2 hover:bg-purple-50">
  ...
  return (
    <Card className="border-2 border-pink-100 bg-gradient-to-br from-pink-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Gestión de habitaciones compartidas y convivencia
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/room-rental">
            <Button variant="outline" className="w-full justify-start gap-2 hover:bg-pink-50 hover:border-pink-300">
              <Home className="h-4 w-4" />
  ...
  return (
    <Card className="border-2 border-green-100 bg-gradient-to-br from-green-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Proyectos de compra-reforma-venta (Flipping)
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <Link href="/flipping">
              <Button variant="outline" size="sm" className="w-full justify-start gap-2 hover:bg-green-50">
  ...
  return (
    <Card className="border-2 border-orange-100 bg-gradient-to-br from-orange-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Gestión de obras, permisos y fases
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/construction">
            <Button variant="outline" className="w-full justify-start gap-2 hover:bg-orange-50 hover:border-orange-300">
              <Building2 className="h-4 w-4" />
  ...
  return (
    <Card className="border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Facturación por horas y gestión de proyectos
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <Link href="/professional">
              <Button variant="outline" size="sm" className="w-full justify-start gap-2 hover:bg-blue-50">
                <Building2 className="h-4 w-4" />
  ...
  return (
    <Card className="border-2 border-teal-100 bg-gradient-to-br from-teal-50 to-white">
      <CardHeader>
        ...
        <CardDescription>
          Administración de fincas y copropietarios
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/comunidad">
            <Button variant="outline" className="w-full justify-start gap-2 hover:bg-teal-50 hover:border-teal-300">
              <Building2 className="h-4 w-4" />
