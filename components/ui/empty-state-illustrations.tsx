...
export function NoBuildingsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      {/* Edificio principal */}
      <rect x="60" y="40" width="80" height="100" rx="4" fill="#E5E7EB" stroke="#9CA3AF" strokeWidth="2" />
      ...
      <circle cx="100" cy="90" r="70" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="5,5" fill="none" opacity="0.5" />
    </svg>
  );
}
...
export function NoUnitsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      ...
      {/* Ventana */}
      <rect x="80" y="75" width="40" height="30" rx="2" fill="#D1D5DB" stroke="#9CA3AF" strokeWidth="1.5" />
      <line x1="100" y1="75" x2="100" y2="105" stroke="#9CA3AF" strokeWidth="1.5" />
      <line x1="80" y1="90" x2="120" y2="90" stroke="#9CA3AF" strokeWidth="1.5" />
      
      {/* Marco decorativo */}
      <rect x="50" y="50" width="100" height="100" rx="4" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="5,5" fill="none" />
    </svg>
  );
}
...
export function NoTenantsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      ...
      <line x1="170" y1="33" x2="170" y2="47" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" />
      <line x1="163" y1="40" x2="177" y2="40" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function NoContractsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      {/* Documento */}
      <path
        d="M60 30H120L150 60V140H60V30Z"
        fill="#E5E7EB"
        stroke="#9CA3AF"
        strokeWidth="2"
      />
      ...
      {/* Líneas de texto */}
      <line x1="75" y1="80" x2="135" y2="80" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
      <line x1="75" y1="95" x2="135" y2="95" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
      <line x1="75" y1="110" x2="110" y2="110" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
...
export function NoPaymentsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      {/* Tarjeta */}
      <rect x="40" y="60" width="120" height="70" rx="8" fill="#E5E7EB" stroke="#9CA3AF" strokeWidth="2" />
      
      {/* Banda magnética */}
      <rect x="40" y="75" width="120" height="15" fill="#9CA3AF" />
      
      {/* Chip */}
      <rect x="55" y="100" width="25" height="20" rx="3" fill="#D1D5DB" stroke="#9CA3AF" strokeWidth="1.5" />
      <rect x="60" y="103" width="15" height="14" rx="2" fill="#FCD34D" />
      
      {/* Números */}
      <line x1="95" y1="110" x2="145" y2="110" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
      <line x1="55" y1="125" x2="100" y2="125" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeWidth="2"
      />
      <rect x="85" y="75" width="40" height="10" rx="2" fill="#E5E7EB" stroke="#9CA3AF" strokeWidth="2" transform="rotate(-45 85 75)" />
      
      {/* Martillo */}
      <rect x="110" y="90" width="50" height="8" rx="2" fill="#E5E7EB" stroke="#9CA3AF" strokeWidth="2" transform="rotate(45 110 90)" />
      <rect x="135" y="65" width="15" height="30" rx="2" fill="#D1D5DB" stroke="#9CA3AF" strokeWidth="2" transform="rotate(45 135 65)" />
      
      {/* Círculo decorativo */}
      <circle cx="100" cy="90" r="60" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="5,5" fill="none" opacity="0.5" />
    </svg>
  );
}
...
export function NoDataIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      {/* Carpeta */}
      <path
        d="M40 60H80L95 50H160V130H40V60Z"
        fill="#E5E7EB"
        stroke="#9CA3AF"
        strokeWidth="2"
      />
      ...
      <line x1="100" y1="88" x2="100" y2="102" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function NoSearchResultsIllustration({ className }: IllustrationProps) {
  return (
    ...
    >
      ...
      <line x1="110" y1="100" x2="140" y2="130" stroke="#9CA3AF" strokeWidth="3" strokeLinecap="round" />
      
      {/* X dentro de la lupa */}
      <line x1="75" y1="65" x2="95" y2="85" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
      <line x1="95" y1="65" x2="75" y2="85" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
