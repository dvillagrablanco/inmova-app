...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    detailedContent: [
      ...
      'Accede a 56 módulos especializados',
  ...
  },
  {
    ...
    detailedContent: [
      'Tienes acceso a 56 módulos completos',
    ...
    tips: [
      ...
      'Explora los 56 módulos desde el menú lateral'
    ],
    icon: '🎖️',
    estimatedTime: '30 seg'
  }
        ...
        <Card className="w-full max-w-3xl shadow-2xl border-2 border-primary/20">
          ...
          <CardFooter className="flex justify-between pt-4 border-t">
            ...
            <div className="flex gap-2">
              ...
              {step.action && (
                <Button onClick={handleAction} className="gradient-primary shadow-lg">
                  {step.action.label}
              ...
              {!step.action && (
                <Button onClick={handleNext} className="gradient-primary shadow-lg">
                  {currentStep === ONBOARDING_STEPS.length - 1 ? (
                    <>
                      <Check className="h-4 w-4 mr-2" />
                      Comenzar a usar INMOVA
                    </>
                  ) : (
                    <>
                      Siguiente
