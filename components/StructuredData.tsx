...
export function StructuredData() {
  const structuredData = {
    ...
    description: 'Software de gestión inmobiliaria profesional todo-en-uno. La plataforma PropTech líder con 56 módulos integrados, 7 modelos de negocio, tecnología avanzada con IA, Blockchain e IoT. Alternativa superior a otras soluciones del mercado.',
    aggregateRating: {
  ...
  const faqData = {
    ...
    mainEntity: [
      {
        '@type': 'Question',
        name: '¿Por qué elegir INMOVA en lugar de Competidor 1, Competidor 2 o Nester?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'INMOVA ofrece 56 módulos profesionales integrados vs los 15-25 de la competencia, soporta 7 modelos de negocio diferentes, incluye tecnología avanzada como IA, Blockchain e IoT, y todo esto desde 149€/mes, siendo hasta 70% más económico que alternativas como Competidor 3 o AppFolio.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Sí, INMOVA incluye un módulo completo de Room Rental para gestión de alquiler por habitaciones y coliving, con prorrateo automático de gastos, calendarios de limpieza rotatorios y gestión de espacios comunes. Una funcionalidad que no ofrecen competidores como Competidor 1 o Competidor 2.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'INMOVA tiene un precio inicial de 149€/mes para el plan Básico, 299€/mes para Profesional y 599€/mes para Enterprise. Esto es significativamente más económico que Competidor 3 (300-800€/mes) o AppFolio (500-1500€/mes), ofreciendo más funcionalidades.',
        },
      },
      {
        '@type': 'Question',
