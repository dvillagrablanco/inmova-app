...
export function HeroSection({ partnerBranding }: HeroSectionProps) {
  const primaryColor = partnerBranding?.coloresPrimarios?.primary || '#6366f1';
  const secondaryColor = partnerBranding?.coloresPrimarios?.secondary || '#8b5cf6';
          ...
          <div className="text-center space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-100 border-2 border-green-300 rounded-full">
              ...
              <span className="text-sm font-bold text-green-700">
                3x más funcionalidad que Competidor 1 • Precio competitivo
              </span>
            </div>

            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight">
              <span className="block text-gray-900 mb-2">7 Verticales. 56 Módulos.</span>
            ...
            <div className="mt-12 max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                {[
                  { number: '56', label: 'Módulos Profesionales', icon: Building2 },
                  { number: '7', label: 'Verticales de Negocio', icon: TrendingUp },
                  { number: '€89', label: 'Desde €89/mes', icon: Star },
