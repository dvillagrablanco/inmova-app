...
const comparisonFeatures = [
  ...
  {
    feature: '🛏️ Coliving / Habitaciones',
    inmova: true,
    competitorA: false,
    competitorB: false,
    competitorC: false,
  ...
  {
    feature: '💼 Servicios Profesionales B2B',
    inmova: true,
    competitorA: false,
    competitorB: false,
    competitorC: false,
  ...
  {
    feature: '⛓️ Blockchain & Tokenización',
    inmova: true,
    competitorA: false,
    competitorB: false,
    competitorC: false,
  ...
  {
    feature: 'Portal Propietarios PWA',
    inmova: true,
    competitorA: false,
    competitorB: false,
    competitorC: true,
  ...
  {
    feature: 'Channel Manager Multi-OTA',
    inmova: true,
    competitorA: true,
    competitorB: false,
    competitorC: true,
  ...
  {
    feature: 'Firma Digital Integrada',
    inmova: true,
    competitorA: true,
    competitorB: false,
    competitorC: false,
...
const pricing = [
  {
    name: 'INMOVA',
    price: '€49/mes',
    modules: '6 verticales + 6 módulos',
    color: 'indigo',
    subtitle: 'Plan Basic',
  },
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Somos la única plataforma que combina{' '}
            <strong>6 verticales + 6 módulos transversales</strong>. Ningún competidor tiene esta
            arquitectura.
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-2xl p-8 max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Link href="/register">
                <Button
                  size="lg"
                  className="bg-white text-indigo-600 hover:bg-gray-100 font-bold px-8 py-6 text-lg whitespace-nowrap"
                >
          ...
          <div className="bg-green-50 border-2 border-green-200 rounded-xl p-6 max-w-2xl mx-auto">
            <p className="text-sm text-gray-700 mb-3">
              ...
              <span className="font-semibold">
                {' '}
                INMOVA ofrece 6x más funcionalidad por 58% menos precio
              </span>
            </p>
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-gray-500 max-w-3xl mx-auto">
            *Comparativa basada en funcionalidades públicas de las principales plataformas PropTech
            del mercado español. Los datos se actualizan trimestralmente. Última actualización: Q1
            2026.
          </p>
        </div>
      </div>
