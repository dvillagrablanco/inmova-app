...
const campaigns: PromoCampaign[] = [
  {
    ...
    subtitle: 'Plan Starter 50% dto. 3 primeros meses',
    description: 'Pasa del Excel a gestión profesional. Contratos, cobros y portal inquilinos desde €17/mes.',
    cta: 'Ver oferta',
  ...
  },
  {
    ...
    description: 'Plan Professional con prorrateo automático de suministros. Ahorra +€130 y olvídate del Excel.',
    cta: 'Ver oferta',
  ...
  },
  {
    ...
    subtitle: 'Igualamos tu precio + Plan superior GRATIS',
    description: '¿Usas otra plataforma? Mismo precio, más funcionalidades. Migración de datos incluida.',
    cta: 'Ver oferta',
