...
export function Navigation({ partnerBranding }: NavigationProps) {
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {partnerBranding?.logoHeader ? (
              <div className="relative h-10 w-auto">
                <Image
                  src={partnerBranding.logoHeader}
            ...
            {partnerBranding && (
              <Badge 
                ...
                style={{
                  borderColor: partnerBranding.coloresPrimarios?.primary || '#6366f1',
                  color: partnerBranding.coloresPrimarios?.primary || '#6366f1',
                }}
              >
                Powered by INMOVA
              </Badge>
