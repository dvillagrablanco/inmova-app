...
const newModules = [
  {
    ...
    desc: 'Gestión completa de liquidaciones: cálculo automático, desglose de honorarios y gastos, exportación PDF',
    features: ['Cálculo automático neto', 'Desglose honorarios/gastos', 'Programación recurrente', 'Exportación PDF'],
    gradient: 'from-emerald-500 to-teal-600',
    stats: { value1: '100%', label1: 'Automatizado', value2: '0', label2: 'Errores' },
    href: '/liquidaciones',
  },
  {
    icon: FileSpreadsheet,
    title: 'Facturación Avanzada',
    desc: 'Series de facturación, IVA/IRPF configurables, proformas, rectificativas y Verifactu',
    features: ['Series personalizables', 'IVA e IRPF automático', 'Proformas y rectificativas', 'Export contable'],
    gradient: 'from-blue-600 to-indigo-600',
    stats: { value1: '21', label1: 'Tipos impuesto', value2: '∞', label2: 'Series' },
    href: '/facturacion',
  },
  {
    icon: Users,
    title: 'Pipeline Prealquiler',
    desc: 'Kanban visual para candidatos: scoring IA, visitas, reservas y conversión a inquilino',
    features: ['Kanban 6 columnas', 'Scoring IA de solvencia', 'Conversión a inquilino 1-click', 'KPIs en tiempo real'],
    gradient: 'from-violet-500 to-purple-600',
    stats: { value1: '6', label1: 'Estados', value2: '+40%', label2: 'Conversión' },
    href: '/candidatos',
  },
  {
    icon: Wrench,
    title: 'Incidencias Kanban',
    desc: 'Pipeline visual de incidencias con clasificación IA, SLAs, presupuestos y chat vinculado',
    features: ['Pipeline visual 5 estados', 'Clasificación IA automática', 'Chat vinculado a incidencia', 'SLAs con countdown'],
    gradient: 'from-orange-500 to-red-500',
    stats: { value1: '60%', label1: 'Menos tiempo', value2: '95%', label2: 'Resolución' },
    href: '/incidencias',
  },
  {
    icon: ClipboardCheck,
    title: 'Check-in / Check-out Digital',
    desc: 'Formularios digitales con token único que el inquilino completa online: inventario, contadores, fotos',
    features: ['Formularios con token', 'Checklist de inventario', 'Lecturas de contadores', 'Firma digital'],
    gradient: 'from-cyan-500 to-blue-500',
    stats: { value1: '0', label1: 'Papel', value2: '100%', label2: 'Digital' },
    href: '/check-in-out',
  },
  {
    icon: BarChart3,
    title: '21 Reportes Avanzados',
    desc: 'Inquilinos, contratos, incidencias, liquidaciones, rentabilidad, impagos, declaración renta y más',
    features: ['21 tipos de reporte', 'Export CSV y PDF', 'Filtros avanzados', 'Cashflow mensual'],
    gradient: 'from-amber-500 to-orange-500',
    stats: { value1: '21', label1: 'Reportes', value2: 'CSV/PDF', label2: 'Export' },
