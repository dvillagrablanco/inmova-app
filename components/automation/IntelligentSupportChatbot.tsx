        ...
        {!isOpen && (
          ...
          >
            <Button
              ...
              className="h-16 w-16 rounded-full shadow-lg hover:shadow-xl transition-all bg-gradient-to-br from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white border-4 border-white dark:border-gray-800"
              aria-label="Abrir asistente INMOVA"
            >
            ...
            <motion.div
              ...
              className="absolute -top-1 -right-1 h-5 w-5 bg-green-500 rounded-full border-3 border-white dark:border-gray-800 shadow-md"
              aria-hidden="true"
            />
          </motion.div>
        )}
              ...
              <CardHeader className="flex-shrink-0 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="text-white hover:bg-white/30 hover:text-white transition-all rounded-full"
